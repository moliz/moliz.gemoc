...
import org.modelexecution.xmof.gemoc.diffbenchmark.internal.util.EpsilonUtil;
...
public class TraceMatcher {
	...
	private EclModule createEclModuleForTraceMatching() {
		EPackage traceEPackage = tracemetamodelResource == null ? StatesPackage.eINSTANCE
