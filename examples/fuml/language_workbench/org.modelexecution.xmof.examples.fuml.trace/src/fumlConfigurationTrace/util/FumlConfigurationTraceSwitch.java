 ...
 * @generated
 */
public class FumlConfigurationTraceSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public FumlConfigurationTraceSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FumlConfigurationTracePackage.SPECIFIC_TRACE: {
