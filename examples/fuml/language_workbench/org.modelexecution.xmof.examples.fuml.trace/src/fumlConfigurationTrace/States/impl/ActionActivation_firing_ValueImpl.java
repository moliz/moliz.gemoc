 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationTrace.States.impl.ActionActivation_firing_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ActionActivation_firing_ValueImpl#isFiring <em>Firing</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ActionActivation_firing_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ActionActivation_firing_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionActivation_firing_ValueImpl extends MinimalEObjectImpl.Container implements ActionActivation_firing_Value {
	...
	public void setParent(TracedActionActivation newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.ACTION_ACTIVATION_FIRING_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, BasicActionsPackage.TRACED_ACTION_ACTIVATION__FIRING_SEQUENCE, TracedActionActivation.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.ACTION_ACTIVATION_FIRING_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, BasicActionsPackage.TRACED_ACTION_ACTIVATION__FIRING_SEQUENCE, TracedActionActivation.class, msgs);
		}
