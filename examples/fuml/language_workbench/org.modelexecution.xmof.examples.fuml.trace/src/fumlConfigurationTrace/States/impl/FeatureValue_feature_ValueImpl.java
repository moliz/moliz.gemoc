 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationTrace.States.impl.FeatureValue_feature_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.FeatureValue_feature_ValueImpl#getFeature <em>Feature</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.FeatureValue_feature_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.FeatureValue_feature_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureValue_feature_ValueImpl extends MinimalEObjectImpl.Container implements FeatureValue_feature_Value {
	 ...
	 * @ordered
	 */
	protected TracedStructuralFeatureConfiguration feature;
	 ...
	 * @generated
	 */
	public TracedStructuralFeatureConfiguration getFeature() {
		if (feature != null && feature.eIsProxy()) {
			InternalEObject oldFeature = (InternalEObject)feature;
			feature = (TracedStructuralFeatureConfiguration)eResolveProxy(oldFeature);
	 ...
	 * @generated
	 */
	public TracedStructuralFeatureConfiguration basicGetFeature() {
		return feature;
	}
	 ...
	 * @generated
	 */
	public void setFeature(TracedStructuralFeatureConfiguration newFeature) {
		TracedStructuralFeatureConfiguration oldFeature = feature;
		feature = newFeature;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case StatesPackage.FEATURE_VALUE_FEATURE_VALUE__FEATURE:
				setFeature((TracedStructuralFeatureConfiguration)newValue);
				return;
			case StatesPackage.FEATURE_VALUE_FEATURE_VALUE__PARENT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case StatesPackage.FEATURE_VALUE_FEATURE_VALUE__FEATURE:
				setFeature((TracedStructuralFeatureConfiguration)null);
				return;
			case StatesPackage.FEATURE_VALUE_FEATURE_VALUE__PARENT:
