 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationTrace.States.impl.ActivityEdgeInstance_edge_ActivityEdgeInstance_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ActivityEdgeInstance_edge_ActivityEdgeInstance_ValueImpl#getEdge_ActivityEdgeInstance <em>Edge Activity Edge Instance</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ActivityEdgeInstance_edge_ActivityEdgeInstance_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ActivityEdgeInstance_edge_ActivityEdgeInstance_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActivityEdgeInstance_edge_ActivityEdgeInstance_ValueImpl extends MinimalEObjectImpl.Container implements ActivityEdgeInstance_edge_ActivityEdgeInstance_Value {
	 ...
	 * @ordered
	 */
	protected TracedActivityEdgeConfiguration edge_ActivityEdgeInstance;
	 ...
	 * @generated
	 */
	public TracedActivityEdgeConfiguration getEdge_ActivityEdgeInstance() {
		if (edge_ActivityEdgeInstance != null && edge_ActivityEdgeInstance.eIsProxy()) {
			...
			edge_ActivityEdgeInstance = (TracedActivityEdgeConfiguration)eResolveProxy(oldEdge_ActivityEdgeInstance);
	 ...
	 * @generated
	 */
	public TracedActivityEdgeConfiguration basicGetEdge_ActivityEdgeInstance() {
		return edge_ActivityEdgeInstance;
	}
	 ...
	 * @generated
	 */
	public void setEdge_ActivityEdgeInstance(TracedActivityEdgeConfiguration newEdge_ActivityEdgeInstance) {
		TracedActivityEdgeConfiguration oldEdge_ActivityEdgeInstance = edge_ActivityEdgeInstance;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case StatesPackage.ACTIVITY_EDGE_INSTANCE_EDGE_ACTIVITY_EDGE_INSTANCE_VALUE__EDGE_ACTIVITY_EDGE_INSTANCE:
				setEdge_ActivityEdgeInstance((TracedActivityEdgeConfiguration)newValue);
				return;
			case StatesPackage.ACTIVITY_EDGE_INSTANCE_EDGE_ACTIVITY_EDGE_INSTANCE_VALUE__PARENT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case StatesPackage.ACTIVITY_EDGE_INSTANCE_EDGE_ACTIVITY_EDGE_INSTANCE_VALUE__EDGE_ACTIVITY_EDGE_INSTANCE:
				setEdge_ActivityEdgeInstance((TracedActivityEdgeConfiguration)null);
				return;
			case StatesPackage.ACTIVITY_EDGE_INSTANCE_EDGE_ACTIVITY_EDGE_INSTANCE_VALUE__PARENT:
