 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationTrace.States.impl.ForkedToken_remainingOffersCount_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ForkedToken_remainingOffersCount_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ForkedToken_remainingOffersCount_ValueImpl#getRemainingOffersCount <em>Remaining Offers Count</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ForkedToken_remainingOffersCount_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForkedToken_remainingOffersCount_ValueImpl extends MinimalEObjectImpl.Container implements ForkedToken_remainingOffersCount_Value {
	...
	public void setParent(TracedForkedToken newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, IntermediateActivitiesPackage.TRACED_FORKED_TOKEN__REMAINING_OFFERS_COUNT_SEQUENCE, TracedForkedToken.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, IntermediateActivitiesPackage.TRACED_FORKED_TOKEN__REMAINING_OFFERS_COUNT_SEQUENCE, TracedForkedToken.class, msgs);
		}
