 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationTrace.States.impl.ParameterValue_parameter_ParameterValue_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ParameterValue_parameter_ParameterValue_ValueImpl#getParameter_ParameterValue <em>Parameter Parameter Value</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ParameterValue_parameter_ParameterValue_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ParameterValue_parameter_ParameterValue_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterValue_parameter_ParameterValue_ValueImpl extends MinimalEObjectImpl.Container implements ParameterValue_parameter_ParameterValue_Value {
	 ...
	 * @ordered
	 */
	protected TracedParameterConfiguration parameter_ParameterValue;
	 ...
	 * @generated
	 */
	public TracedParameterConfiguration getParameter_ParameterValue() {
		if (parameter_ParameterValue != null && parameter_ParameterValue.eIsProxy()) {
			...
			parameter_ParameterValue = (TracedParameterConfiguration)eResolveProxy(oldParameter_ParameterValue);
	 ...
	 * @generated
	 */
	public TracedParameterConfiguration basicGetParameter_ParameterValue() {
		return parameter_ParameterValue;
	}
	 ...
	 * @generated
	 */
	public void setParameter_ParameterValue(TracedParameterConfiguration newParameter_ParameterValue) {
		TracedParameterConfiguration oldParameter_ParameterValue = parameter_ParameterValue;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case StatesPackage.PARAMETER_VALUE_PARAMETER_PARAMETER_VALUE_VALUE__PARAMETER_PARAMETER_VALUE:
				setParameter_ParameterValue((TracedParameterConfiguration)newValue);
				return;
			case StatesPackage.PARAMETER_VALUE_PARAMETER_PARAMETER_VALUE_VALUE__PARENT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case StatesPackage.PARAMETER_VALUE_PARAMETER_PARAMETER_VALUE_VALUE__PARAMETER_PARAMETER_VALUE:
				setParameter_ParameterValue((TracedParameterConfiguration)null);
				return;
			case StatesPackage.PARAMETER_VALUE_PARAMETER_PARAMETER_VALUE_VALUE__PARENT:
