 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationTrace.States.impl.Object_types_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.Object_types_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.Object_types_ValueImpl#getStates <em>States</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.Object_types_ValueImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Object_types_ValueImpl extends MinimalEObjectImpl.Container implements Object_types_Value {
	 ...
	 * @ordered
	 */
	protected EList<TracedClassConfiguration> types;
	 ...
	 * @generated
	 */
	public EList<TracedClassConfiguration> getTypes() {
		if (types == null) {
			types = new EObjectResolvingEList<TracedClassConfiguration>(TracedClassConfiguration.class, this, StatesPackage.OBJECT_TYPES_VALUE__TYPES);
		}
		return types;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StatesPackage.OBJECT_TYPES_VALUE__TYPES:
				getTypes().clear();
				getTypes().addAll((Collection<? extends TracedClassConfiguration>)newValue);
				return;
		}
