 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationTrace.States.impl.Offer_offeredTokens_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.Offer_offeredTokens_ValueImpl#getOfferedTokens <em>Offered Tokens</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.Offer_offeredTokens_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.Offer_offeredTokens_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Offer_offeredTokens_ValueImpl extends MinimalEObjectImpl.Container implements Offer_offeredTokens_Value {
	...
	public void setParent(TracedOffer newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.OFFER_OFFERED_TOKENS_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, IntermediateActivitiesPackage.TRACED_OFFER__OFFERED_TOKENS_SEQUENCE, TracedOffer.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.OFFER_OFFERED_TOKENS_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, IntermediateActivitiesPackage.TRACED_OFFER__OFFERED_TOKENS_SEQUENCE, TracedOffer.class, msgs);
		}
