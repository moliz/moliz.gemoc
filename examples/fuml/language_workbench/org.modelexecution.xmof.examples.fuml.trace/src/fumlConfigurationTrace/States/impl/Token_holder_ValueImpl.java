 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationTrace.States.impl.Token_holder_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.Token_holder_ValueImpl#getHolder <em>Holder</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.Token_holder_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.Token_holder_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Token_holder_ValueImpl extends MinimalEObjectImpl.Container implements Token_holder_Value {
	 ...
	 * @ordered
	 */
	protected TracedActivityNodeActivation holder;
	 ...
	 * @generated
	 */
	public TracedActivityNodeActivation getHolder() {
		if (holder != null && holder.eIsProxy()) {
			InternalEObject oldHolder = (InternalEObject)holder;
			holder = (TracedActivityNodeActivation)eResolveProxy(oldHolder);
			if (holder != oldHolder) {
	 ...
	 * @generated
	 */
	public TracedActivityNodeActivation basicGetHolder() {
		return holder;
	}
	 ...
	 * @generated
	 */
	public void setHolder(TracedActivityNodeActivation newHolder) {
		TracedActivityNodeActivation oldHolder = holder;
		holder = newHolder;
		if (eNotificationRequired())
	...
	public void setParent(TracedToken newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.TOKEN_HOLDER_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, IntermediateActivitiesPackage.TRACED_TOKEN__HOLDER_SEQUENCE, TracedToken.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.TOKEN_HOLDER_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, IntermediateActivitiesPackage.TRACED_TOKEN__HOLDER_SEQUENCE, TracedToken.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case StatesPackage.TOKEN_HOLDER_VALUE__HOLDER:
				setHolder((TracedActivityNodeActivation)newValue);
				return;
			case StatesPackage.TOKEN_HOLDER_VALUE__PARENT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case StatesPackage.TOKEN_HOLDER_VALUE__HOLDER:
				setHolder((TracedActivityNodeActivation)null);
				return;
			case StatesPackage.TOKEN_HOLDER_VALUE__PARENT:
