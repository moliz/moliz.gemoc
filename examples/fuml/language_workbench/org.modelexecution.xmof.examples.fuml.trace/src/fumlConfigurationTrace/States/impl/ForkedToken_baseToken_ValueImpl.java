 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationTrace.States.impl.ForkedToken_baseToken_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ForkedToken_baseToken_ValueImpl#getBaseToken <em>Base Token</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ForkedToken_baseToken_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fumlConfigurationTrace.States.impl.ForkedToken_baseToken_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForkedToken_baseToken_ValueImpl extends MinimalEObjectImpl.Container implements ForkedToken_baseToken_Value {
	...
	public void setParent(TracedForkedToken newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.FORKED_TOKEN_BASE_TOKEN_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, IntermediateActivitiesPackage.TRACED_FORKED_TOKEN__BASE_TOKEN_SEQUENCE, TracedForkedToken.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.FORKED_TOKEN_BASE_TOKEN_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, IntermediateActivitiesPackage.TRACED_FORKED_TOKEN__BASE_TOKEN_SEQUENCE, TracedForkedToken.class, msgs);
		}
