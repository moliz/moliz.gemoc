...
import fumlConfigurationTrace.Steps.StepsFactory;
...
public class StepsPackageImpl extends EPackageImpl implements StepsPackage {
	 ...
	 * @see fumlConfigurationTrace.Steps.StepsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("fumlConfigurationTrace.Steps." + eClassifier.getName());
