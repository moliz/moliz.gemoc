 ...
 * </p>
 * <ul>
 *   <li>{@link umlTrace.Steps.impl.FumlConfiguration_Actions_IntermediateActions_ReadStructuralFeatureActionActivation_DoAction_ReadStructuralFeatureActionActivationImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link umlTrace.Steps.impl.FumlConfiguration_Actions_IntermediateActions_ReadStructuralFeatureActionActivation_DoAction_ReadStructuralFeatureActionActivationImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link umlTrace.Steps.impl.FumlConfiguration_Actions_IntermediateActions_ReadStructuralFeatureActionActivation_DoAction_ReadStructuralFeatureActionActivationImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FumlConfiguration_Actions_IntermediateActions_ReadStructuralFeatureActionActivation_DoAction_ReadStructuralFeatureActionActivationImpl extends StepImpl implements FumlConfiguration_Actions_IntermediateActions_ReadStructuralFeatureActionActivation_DoAction_ReadStructuralFeatureActionActivation {
	 ...
	 * @generated
	 */
	public ReadStructuralFeatureActionActivation getCaller() {
		return (fumlConfiguration.Actions.IntermediateActions.ReadStructuralFeatureActionActivation) this.getMseoccurrence().getMse().getCaller();
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.FUML_CONFIGURATION_ACTIONS_INTERMEDIATE_ACTIONS_READ_STRUCTURAL_FEATURE_ACTION_ACTIVATION_DO_ACTION_READ_STRUCTURAL_FEATURE_ACTION_ACTIVATION__SUB_STEPS: return MsePackage.BIG_STEP__SUB_STEPS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (baseFeatureID) {
				case MsePackage.BIG_STEP__SUB_STEPS: return StepsPackage.FUML_CONFIGURATION_ACTIONS_INTERMEDIATE_ACTIONS_READ_STRUCTURAL_FEATURE_ACTION_ACTIVATION_DO_ACTION_READ_STRUCTURAL_FEATURE_ACTION_ACTIVATION__SUB_STEPS;
				default: return -1;
			}
		}
		if (baseClass == SequentialStep.class) {
