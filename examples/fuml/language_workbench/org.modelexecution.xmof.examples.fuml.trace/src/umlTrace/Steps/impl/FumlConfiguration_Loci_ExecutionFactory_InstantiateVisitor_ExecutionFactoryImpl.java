...
import umlTrace.Steps.FumlConfiguration_Loci_ExecutionFactory_InstantiateVisitor_ExecutionFactory_AbstractSubStep;
 ...
 * </p>
 * <ul>
 *   <li>{@link umlTrace.Steps.impl.FumlConfiguration_Loci_ExecutionFactory_InstantiateVisitor_ExecutionFactoryImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link umlTrace.Steps.impl.FumlConfiguration_Loci_ExecutionFactory_InstantiateVisitor_ExecutionFactoryImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link umlTrace.Steps.impl.FumlConfiguration_Loci_ExecutionFactory_InstantiateVisitor_ExecutionFactoryImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FumlConfiguration_Loci_ExecutionFactory_InstantiateVisitor_ExecutionFactoryImpl extends StepImpl implements FumlConfiguration_Loci_ExecutionFactory_InstantiateVisitor_ExecutionFactory {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == BigStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.FUML_CONFIGURATION_LOCI_EXECUTION_FACTORY_INSTANTIATE_VISITOR_EXECUTION_FACTORY__SUB_STEPS: return MsePackage.BIG_STEP__SUB_STEPS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == BigStep.class) {
			switch (baseFeatureID) {
				case MsePackage.BIG_STEP__SUB_STEPS: return StepsPackage.FUML_CONFIGURATION_LOCI_EXECUTION_FACTORY_INSTANTIATE_VISITOR_EXECUTION_FACTORY__SUB_STEPS;
				default: return -1;
			}
		}
		if (baseClass == SequentialStep.class) {
