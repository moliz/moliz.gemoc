 ...
 * </p>
 * <ul>
 *   <li>{@link umlTrace.States.State#getActionActivation_firing_Values <em>Action Activation firing Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActionActivation_pinActivations_Values <em>Action Activation pin Activations Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityEdgeInstance_edge_ActivityEdgeInstance_Values <em>Activity Edge Instance edge Activity Edge Instance Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityEdgeInstance_group_ActivityEdgeInstance_Values <em>Activity Edge Instance group Activity Edge Instance Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityEdgeInstance_offers_Values <em>Activity Edge Instance offers Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityEdgeInstance_source_Values <em>Activity Edge Instance source Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityEdgeInstance_target_Values <em>Activity Edge Instance target Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityExecution_activationGroup_Values <em>Activity Execution activation Group Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityNodeActivationGroup_activityExecution_Values <em>Activity Node Activation Group activity Execution Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityNodeActivationGroup_edgeInstances_Values <em>Activity Node Activation Group edge Instances Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityNodeActivationGroup_nodeActivations_Values <em>Activity Node Activation Group node Activations Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityNodeActivation_group_ActivityNodeActivation_Values <em>Activity Node Activation group Activity Node Activation Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityNodeActivation_heldTokens_Values <em>Activity Node Activation held Tokens Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityNodeActivation_incomingEdges_Values <em>Activity Node Activation incoming Edges Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityNodeActivation_isRunning_Values <em>Activity Node Activation is Running Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityNodeActivation_node_ActivityNodeActivation_Values <em>Activity Node Activation node Activity Node Activation Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityNodeActivation_outgoingEdges_Values <em>Activity Node Activation outgoing Edges Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getActivityNodeActivation_running_Values <em>Activity Node Activation running Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getBooleanValue_value_BooleanValue_Values <em>Boolean Value value Boolean Value Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getCallActionActivation_callExecutions_Values <em>Call Action Activation call Executions Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getCompoundValue_featureValues_Values <em>Compound Value feature Values Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getElementConfiguration_semanticVisitor_Values <em>Element Configuration semantic Visitor Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getEndedSteps <em>Ended Steps</em>}</li>
 *   <li>{@link umlTrace.States.State#getEvaluation_locus_Evaluation_Values <em>Evaluation locus Evaluation Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getEvaluation_specification_Evaluation_Values <em>Evaluation specification Evaluation Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getExecutionEnvironment_locus_ExecutionEnvironment_Values <em>Execution Environment locus Execution Environment Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getExecutionFactory_builtInTypes_Values <em>Execution Factory built In Types Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getExecutionFactory_locus_ExecutionFactory_Values <em>Execution Factory locus Execution Factory Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getExecutionFactory_primitiveBehaviorPrototypes_Values <em>Execution Factory primitive Behavior Prototypes Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getExecution_context_Values <em>Execution context Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getExecution_parameterValues_Values <em>Execution parameter Values Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getExecutor_locus_Executor_Values <em>Executor locus Executor Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getExtensionalValue_locus_ExtensionalValue_Values <em>Extensional Value locus Extensional Value Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getFeatureValue_feature_Values <em>Feature Value feature Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getFeatureValue_position_Values <em>Feature Value position Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getFeatureValue_values_FeatureValue_Values <em>Feature Value values Feature Value Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getForkedToken_baseTokenIsWithdrawn_Values <em>Forked Token base Token Is Withdrawn Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getForkedToken_baseToken_Values <em>Forked Token base Token Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getForkedToken_remainingOffersCount_Values <em>Forked Token remaining Offers Count Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getInputParameterValues_name_Values <em>Input Parameter Values name Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getInputParameterValues_parameterValues_Values <em>Input Parameter Values parameter Values Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getIntegerValue_value_IntegerValue_Values <em>Integer Value value Integer Value Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getLocus_executor_Values <em>Locus executor Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getLocus_extensionalValues_Values <em>Locus extensional Values Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getLocus_factory_Values <em>Locus factory Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getObjectNodeActivation_offeredTokenCount_Values <em>Object Node Activation offered Token Count Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getObjectToken_value_Values <em>Object Token value Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getObject_types_Values <em>Object types Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getOffer_offeredTokens_Values <em>Offer offered Tokens Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getParameterValue_parameter_ParameterValue_Values <em>Parameter Value parameter Parameter Value Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getParameterValue_values_ParameterValue_Values <em>Parameter Value values Parameter Value Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getPinActivation_actionActivation_Values <em>Pin Activation action Activation Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getPinActivation_count_temp_Values <em>Pin Activation count temp Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getPrimitiveValue_type_Values <em>Primitive Value type Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getReference_referent_Values <em>Reference referent Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getSemanticVisitor_runtimeModelElement_Values <em>Semantic Visitor runtime Model Element Values</em>}</li>
 *   <li>{@link umlTrace.States.State#getStartedSteps <em>Started Steps</em>}</li>
 *   <li>{@link umlTrace.States.State#getToken_holder_Values <em>Token holder Values</em>}</li>
 * </ul>
 *
 * @see umlTrace.States.StatesPackage#getState()
 * @model
 * @generated
 */
public interface State extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActionActivation_firing_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActionActivation_firing_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActionActivation_pinActivations_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActionActivation_pinActivations_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityEdgeInstance_edge_ActivityEdgeInstance_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityEdgeInstance_edge_ActivityEdgeInstance_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityEdgeInstance_group_ActivityEdgeInstance_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityEdgeInstance_group_ActivityEdgeInstance_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityEdgeInstance_offers_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityEdgeInstance_offers_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityEdgeInstance_source_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityEdgeInstance_source_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityEdgeInstance_target_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityEdgeInstance_target_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityExecution_activationGroup_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityExecution_activationGroup_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityNodeActivationGroup_activityExecution_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityNodeActivationGroup_activityExecution_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityNodeActivationGroup_edgeInstances_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityNodeActivationGroup_edgeInstances_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityNodeActivationGroup_nodeActivations_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityNodeActivationGroup_nodeActivations_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityNodeActivation_group_ActivityNodeActivation_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityNodeActivation_group_ActivityNodeActivation_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityNodeActivation_heldTokens_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityNodeActivation_heldTokens_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityNodeActivation_incomingEdges_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityNodeActivation_incomingEdges_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityNodeActivation_isRunning_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityNodeActivation_isRunning_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityNodeActivation_node_ActivityNodeActivation_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityNodeActivation_node_ActivityNodeActivation_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityNodeActivation_outgoingEdges_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityNodeActivation_outgoingEdges_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ActivityNodeActivation_running_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ActivityNodeActivation_running_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.BooleanValue_value_BooleanValue_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_BooleanValue_value_BooleanValue_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.CallActionActivation_callExecutions_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_CallActionActivation_callExecutions_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.CompoundValue_featureValues_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_CompoundValue_featureValues_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ElementConfiguration_semanticVisitor_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ElementConfiguration_semanticVisitor_Values()
	 ...
	 * The list contents are of type {@link umlTrace.Steps.SpecificStep}.
	 * It is bidirectional and its opposite is '{@link umlTrace.Steps.SpecificStep#getEndingState <em>Ending State</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_EndedSteps()
	 * @see umlTrace.Steps.SpecificStep#getEndingState
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.Evaluation_locus_Evaluation_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_Evaluation_locus_Evaluation_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.Evaluation_specification_Evaluation_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_Evaluation_specification_Evaluation_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ExecutionEnvironment_locus_ExecutionEnvironment_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ExecutionEnvironment_locus_ExecutionEnvironment_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ExecutionFactory_builtInTypes_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ExecutionFactory_builtInTypes_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ExecutionFactory_locus_ExecutionFactory_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ExecutionFactory_locus_ExecutionFactory_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ExecutionFactory_primitiveBehaviorPrototypes_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ExecutionFactory_primitiveBehaviorPrototypes_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.Execution_context_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_Execution_context_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.Execution_parameterValues_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_Execution_parameterValues_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.Executor_locus_Executor_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_Executor_locus_Executor_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ExtensionalValue_locus_ExtensionalValue_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ExtensionalValue_locus_ExtensionalValue_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.FeatureValue_feature_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_FeatureValue_feature_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.FeatureValue_position_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_FeatureValue_position_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.FeatureValue_values_FeatureValue_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_FeatureValue_values_FeatureValue_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ForkedToken_baseTokenIsWithdrawn_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ForkedToken_baseTokenIsWithdrawn_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ForkedToken_baseToken_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ForkedToken_baseToken_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ForkedToken_remainingOffersCount_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ForkedToken_remainingOffersCount_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.InputParameterValues_name_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_InputParameterValues_name_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.InputParameterValues_parameterValues_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_InputParameterValues_parameterValues_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.IntegerValue_value_IntegerValue_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_IntegerValue_value_IntegerValue_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.Locus_executor_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_Locus_executor_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.Locus_extensionalValues_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_Locus_extensionalValues_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.Locus_factory_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_Locus_factory_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ObjectNodeActivation_offeredTokenCount_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ObjectNodeActivation_offeredTokenCount_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ObjectToken_value_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ObjectToken_value_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.Object_types_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_Object_types_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.Offer_offeredTokens_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_Offer_offeredTokens_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ParameterValue_parameter_ParameterValue_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ParameterValue_parameter_ParameterValue_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.ParameterValue_values_ParameterValue_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_ParameterValue_values_ParameterValue_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.PinActivation_actionActivation_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_PinActivation_actionActivation_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.PinActivation_count_temp_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_PinActivation_count_temp_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.PrimitiveValue_type_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_PrimitiveValue_type_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.Reference_referent_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_Reference_referent_Values()
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.SemanticVisitor_runtimeModelElement_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_SemanticVisitor_runtimeModelElement_Values()
	 ...
	 * The list contents are of type {@link umlTrace.Steps.SpecificStep}.
	 * It is bidirectional and its opposite is '{@link umlTrace.Steps.SpecificStep#getStartingState <em>Starting State</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_StartedSteps()
	 * @see umlTrace.Steps.SpecificStep#getStartingState
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.Token_holder_Value#getStates <em>States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getState_Token_holder_Values()
