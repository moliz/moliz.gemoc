 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see umlTrace.States.fumlConfiguration.Input.InputFactory
 * @model kind="package"
 * @generated
 */
public interface InputPackage extends EPackage {
	 ...
	 * @generated
	 */
	InputPackage eINSTANCE = umlTrace.States.fumlConfiguration.Input.impl.InputPackageImpl.init();

	/**
	 * The meta object id for the '{@link umlTrace.States.fumlConfiguration.Input.impl.TracedInputParameterValuesImpl <em>Traced Input Parameter Values</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see umlTrace.States.fumlConfiguration.Input.impl.TracedInputParameterValuesImpl
	 * @see umlTrace.States.fumlConfiguration.Input.impl.InputPackageImpl#getTracedInputParameterValues()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link umlTrace.States.fumlConfiguration.Input.TracedInputParameterValues <em>Traced Input Parameter Values</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Traced Input Parameter Values</em>'.
	 * @see umlTrace.States.fumlConfiguration.Input.TracedInputParameterValues
	 * @generated
	 */
	EClass getTracedInputParameterValues();

	/**
	 * Returns the meta object for the containment reference list '{@link umlTrace.States.fumlConfiguration.Input.TracedInputParameterValues#getNameSequence <em>Name Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link umlTrace.States.fumlConfiguration.Input.impl.TracedInputParameterValuesImpl <em>Traced Input Parameter Values</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see umlTrace.States.fumlConfiguration.Input.impl.TracedInputParameterValuesImpl
		 * @see umlTrace.States.fumlConfiguration.Input.impl.InputPackageImpl#getTracedInputParameterValues()
