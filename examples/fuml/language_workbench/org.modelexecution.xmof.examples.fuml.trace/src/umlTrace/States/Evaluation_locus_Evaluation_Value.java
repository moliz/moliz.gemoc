 ...
 * </p>
 * <ul>
 *   <li>{@link umlTrace.States.Evaluation_locus_Evaluation_Value#getLocus_Evaluation <em>Locus Evaluation</em>}</li>
 *   <li>{@link umlTrace.States.Evaluation_locus_Evaluation_Value#getParent <em>Parent</em>}</li>
 *   <li>{@link umlTrace.States.Evaluation_locus_Evaluation_Value#getStates <em>States</em>}</li>
 * </ul>
 *
 * @see umlTrace.States.StatesPackage#getEvaluation_locus_Evaluation_Value()
...
public interface Evaluation_locus_Evaluation_Value extends Value {
	 ...
	 * @see umlTrace.States.StatesPackage#getEvaluation_locus_Evaluation_Value_Locus_Evaluation()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.Evaluation_locus_Evaluation_Value#getLocus_Evaluation <em>Locus Evaluation</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.fumlConfiguration.Classes.Kernel.TracedEvaluation#getLocus_EvaluationSequence <em>Locus Evaluation Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getEvaluation_locus_Evaluation_Value_Parent()
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.Evaluation_locus_Evaluation_Value#getParent <em>Parent</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.State#getEvaluation_locus_Evaluation_Values <em>Evaluation locus Evaluation Values</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getEvaluation_locus_Evaluation_Value_States()
