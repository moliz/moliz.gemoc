 ...
 * </p>
 * <ul>
 *   <li>{@link umlTrace.States.ActivityNodeActivation_isRunning_Value#isIsRunning <em>Is Running</em>}</li>
 *   <li>{@link umlTrace.States.ActivityNodeActivation_isRunning_Value#getParent <em>Parent</em>}</li>
 *   <li>{@link umlTrace.States.ActivityNodeActivation_isRunning_Value#getStates <em>States</em>}</li>
 * </ul>
 *
 * @see umlTrace.States.StatesPackage#getActivityNodeActivation_isRunning_Value()
...
public interface ActivityNodeActivation_isRunning_Value extends Value {
	 ...
	 * @see umlTrace.States.StatesPackage#getActivityNodeActivation_isRunning_Value_IsRunning()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.ActivityNodeActivation_isRunning_Value#isIsRunning <em>Is Running</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.fumlConfiguration.Activities.IntermediateActivities.TracedActivityNodeActivation#getIsRunningSequence <em>Is Running Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getActivityNodeActivation_isRunning_Value_Parent()
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.ActivityNodeActivation_isRunning_Value#getParent <em>Parent</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.State#getActivityNodeActivation_isRunning_Values <em>Activity Node Activation is Running Values</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getActivityNodeActivation_isRunning_Value_States()
