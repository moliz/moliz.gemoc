 ...
 * </p>
 * <ul>
 *   <li>{@link umlTrace.States.ActivityNodeActivation_running_Value#getParent <em>Parent</em>}</li>
 *   <li>{@link umlTrace.States.ActivityNodeActivation_running_Value#isRunning <em>Running</em>}</li>
 *   <li>{@link umlTrace.States.ActivityNodeActivation_running_Value#getStates <em>States</em>}</li>
 * </ul>
 *
 * @see umlTrace.States.StatesPackage#getActivityNodeActivation_running_Value()
...
public interface ActivityNodeActivation_running_Value extends Value {
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.fumlConfiguration.Activities.IntermediateActivities.TracedActivityNodeActivation#getRunningSequence <em>Running Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getActivityNodeActivation_running_Value_Parent()
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.ActivityNodeActivation_running_Value#getParent <em>Parent</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see umlTrace.States.StatesPackage#getActivityNodeActivation_running_Value_Running()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.ActivityNodeActivation_running_Value#isRunning <em>Running</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.State#getActivityNodeActivation_running_Values <em>Activity Node Activation running Values</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getActivityNodeActivation_running_Value_States()
