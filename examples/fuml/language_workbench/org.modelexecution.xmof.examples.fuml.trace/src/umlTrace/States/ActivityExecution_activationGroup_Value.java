 ...
 * </p>
 * <ul>
 *   <li>{@link umlTrace.States.ActivityExecution_activationGroup_Value#getActivationGroup <em>Activation Group</em>}</li>
 *   <li>{@link umlTrace.States.ActivityExecution_activationGroup_Value#getParent <em>Parent</em>}</li>
 *   <li>{@link umlTrace.States.ActivityExecution_activationGroup_Value#getStates <em>States</em>}</li>
 * </ul>
 *
 * @see umlTrace.States.StatesPackage#getActivityExecution_activationGroup_Value()
...
public interface ActivityExecution_activationGroup_Value extends Value {
	 ...
	 * @see umlTrace.States.StatesPackage#getActivityExecution_activationGroup_Value_ActivationGroup()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.ActivityExecution_activationGroup_Value#getActivationGroup <em>Activation Group</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.fumlConfiguration.Activities.IntermediateActivities.TracedActivityExecution#getActivationGroupSequence <em>Activation Group Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getActivityExecution_activationGroup_Value_Parent()
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.ActivityExecution_activationGroup_Value#getParent <em>Parent</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.State#getActivityExecution_activationGroup_Values <em>Activity Execution activation Group Values</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getActivityExecution_activationGroup_Value_States()
