 ...
 * </p>
 * <ul>
 *   <li>{@link umlTrace.States.ExecutionEnvironment_locus_ExecutionEnvironment_Value#getLocus_ExecutionEnvironment <em>Locus Execution Environment</em>}</li>
 *   <li>{@link umlTrace.States.ExecutionEnvironment_locus_ExecutionEnvironment_Value#getParent <em>Parent</em>}</li>
 *   <li>{@link umlTrace.States.ExecutionEnvironment_locus_ExecutionEnvironment_Value#getStates <em>States</em>}</li>
 * </ul>
 *
 * @see umlTrace.States.StatesPackage#getExecutionEnvironment_locus_ExecutionEnvironment_Value()
...
public interface ExecutionEnvironment_locus_ExecutionEnvironment_Value extends Value {
	 ...
	 * @see umlTrace.States.StatesPackage#getExecutionEnvironment_locus_ExecutionEnvironment_Value_Locus_ExecutionEnvironment()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.ExecutionEnvironment_locus_ExecutionEnvironment_Value#getLocus_ExecutionEnvironment <em>Locus Execution Environment</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.fumlConfiguration.Loci.TracedExecutionEnvironment#getLocus_ExecutionEnvironmentSequence <em>Locus Execution Environment Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getExecutionEnvironment_locus_ExecutionEnvironment_Value_Parent()
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.ExecutionEnvironment_locus_ExecutionEnvironment_Value#getParent <em>Parent</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.State#getExecutionEnvironment_locus_ExecutionEnvironment_Values <em>Execution Environment locus Execution Environment Values</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getExecutionEnvironment_locus_ExecutionEnvironment_Value_States()
