 ...
 * </p>
 * <ul>
 *   <li>{@link umlTrace.States.ActionActivation_pinActivations_Value#getParent <em>Parent</em>}</li>
 *   <li>{@link umlTrace.States.ActionActivation_pinActivations_Value#getPinActivations <em>Pin Activations</em>}</li>
 *   <li>{@link umlTrace.States.ActionActivation_pinActivations_Value#getStates <em>States</em>}</li>
 * </ul>
 *
 * @see umlTrace.States.StatesPackage#getActionActivation_pinActivations_Value()
...
public interface ActionActivation_pinActivations_Value extends Value {
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.fumlConfiguration.Actions.BasicActions.TracedActionActivation#getPinActivationsSequence <em>Pin Activations Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getActionActivation_pinActivations_Value_Parent()
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.ActionActivation_pinActivations_Value#getParent <em>Parent</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link umlTrace.States.fumlConfiguration.Actions.BasicActions.TracedPinActivation}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getActionActivation_pinActivations_Value_PinActivations()
	 * @model annotation="http://www.modelexecution.org/trace/XMOF executionMetamodelElement='//Actions/BasicActions/ActionActivation/pinActivations'"
	 * @generated
	 */
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.State#getActionActivation_pinActivations_Values <em>Action Activation pin Activations Values</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getActionActivation_pinActivations_Value_States()
