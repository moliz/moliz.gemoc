 ...
 * </p>
 * <ul>
 *   <li>{@link umlTrace.States.Execution_context_Value#getContext <em>Context</em>}</li>
 *   <li>{@link umlTrace.States.Execution_context_Value#getParent <em>Parent</em>}</li>
 *   <li>{@link umlTrace.States.Execution_context_Value#getStates <em>States</em>}</li>
 * </ul>
 *
 * @see umlTrace.States.StatesPackage#getExecution_context_Value()
...
public interface Execution_context_Value extends Value {
	 ...
	 * @see umlTrace.States.StatesPackage#getExecution_context_Value_Context()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.Execution_context_Value#getContext <em>Context</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.fumlConfiguration.CommonBehaviors.BasicBehaviors.TracedExecution#getContextSequence <em>Context Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getExecution_context_Value_Parent()
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.Execution_context_Value#getParent <em>Parent</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.State#getExecution_context_Values <em>Execution context Values</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getExecution_context_Value_States()
