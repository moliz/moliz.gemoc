 ...
 * </p>
 * <ul>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActionActivation_firing_Values <em>Action Activation firing Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActionActivation_pinActivations_Values <em>Action Activation pin Activations Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityEdgeInstance_edge_ActivityEdgeInstance_Values <em>Activity Edge Instance edge Activity Edge Instance Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityEdgeInstance_group_ActivityEdgeInstance_Values <em>Activity Edge Instance group Activity Edge Instance Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityEdgeInstance_offers_Values <em>Activity Edge Instance offers Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityEdgeInstance_source_Values <em>Activity Edge Instance source Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityEdgeInstance_target_Values <em>Activity Edge Instance target Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityExecution_activationGroup_Values <em>Activity Execution activation Group Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityNodeActivationGroup_activityExecution_Values <em>Activity Node Activation Group activity Execution Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityNodeActivationGroup_edgeInstances_Values <em>Activity Node Activation Group edge Instances Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityNodeActivationGroup_nodeActivations_Values <em>Activity Node Activation Group node Activations Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityNodeActivation_group_ActivityNodeActivation_Values <em>Activity Node Activation group Activity Node Activation Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityNodeActivation_heldTokens_Values <em>Activity Node Activation held Tokens Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityNodeActivation_incomingEdges_Values <em>Activity Node Activation incoming Edges Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityNodeActivation_isRunning_Values <em>Activity Node Activation is Running Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityNodeActivation_node_ActivityNodeActivation_Values <em>Activity Node Activation node Activity Node Activation Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityNodeActivation_outgoingEdges_Values <em>Activity Node Activation outgoing Edges Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getActivityNodeActivation_running_Values <em>Activity Node Activation running Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getBooleanValue_value_BooleanValue_Values <em>Boolean Value value Boolean Value Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getCallActionActivation_callExecutions_Values <em>Call Action Activation call Executions Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getCompoundValue_featureValues_Values <em>Compound Value feature Values Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getElementConfiguration_semanticVisitor_Values <em>Element Configuration semantic Visitor Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getEndedSteps <em>Ended Steps</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getEvaluation_locus_Evaluation_Values <em>Evaluation locus Evaluation Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getEvaluation_specification_Evaluation_Values <em>Evaluation specification Evaluation Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getExecutionEnvironment_locus_ExecutionEnvironment_Values <em>Execution Environment locus Execution Environment Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getExecutionFactory_builtInTypes_Values <em>Execution Factory built In Types Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getExecutionFactory_locus_ExecutionFactory_Values <em>Execution Factory locus Execution Factory Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getExecutionFactory_primitiveBehaviorPrototypes_Values <em>Execution Factory primitive Behavior Prototypes Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getExecution_context_Values <em>Execution context Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getExecution_parameterValues_Values <em>Execution parameter Values Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getExecutor_locus_Executor_Values <em>Executor locus Executor Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getExtensionalValue_locus_ExtensionalValue_Values <em>Extensional Value locus Extensional Value Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getFeatureValue_feature_Values <em>Feature Value feature Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getFeatureValue_position_Values <em>Feature Value position Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getFeatureValue_values_FeatureValue_Values <em>Feature Value values Feature Value Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getForkedToken_baseTokenIsWithdrawn_Values <em>Forked Token base Token Is Withdrawn Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getForkedToken_baseToken_Values <em>Forked Token base Token Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getForkedToken_remainingOffersCount_Values <em>Forked Token remaining Offers Count Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getInputParameterValues_name_Values <em>Input Parameter Values name Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getInputParameterValues_parameterValues_Values <em>Input Parameter Values parameter Values Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getIntegerValue_value_IntegerValue_Values <em>Integer Value value Integer Value Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getLocus_executor_Values <em>Locus executor Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getLocus_extensionalValues_Values <em>Locus extensional Values Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getLocus_factory_Values <em>Locus factory Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getObjectNodeActivation_offeredTokenCount_Values <em>Object Node Activation offered Token Count Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getObjectToken_value_Values <em>Object Token value Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getObject_types_Values <em>Object types Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getOffer_offeredTokens_Values <em>Offer offered Tokens Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getParameterValue_parameter_ParameterValue_Values <em>Parameter Value parameter Parameter Value Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getParameterValue_values_ParameterValue_Values <em>Parameter Value values Parameter Value Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getPinActivation_actionActivation_Values <em>Pin Activation action Activation Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getPinActivation_count_temp_Values <em>Pin Activation count temp Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getPrimitiveValue_type_Values <em>Primitive Value type Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getReference_referent_Values <em>Reference referent Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getSemanticVisitor_runtimeModelElement_Values <em>Semantic Visitor runtime Model Element Values</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getStartedSteps <em>Started Steps</em>}</li>
 *   <li>{@link umlTrace.States.impl.StateImpl#getToken_holder_Values <em>Token holder Values</em>}</li>
 * </ul>
 *
 * @generated
 */
