 ...
 * </p>
 * <ul>
 *   <li>{@link umlTrace.States.ActivityNodeActivationGroup_nodeActivations_Value#getNodeActivations <em>Node Activations</em>}</li>
 *   <li>{@link umlTrace.States.ActivityNodeActivationGroup_nodeActivations_Value#getParent <em>Parent</em>}</li>
 *   <li>{@link umlTrace.States.ActivityNodeActivationGroup_nodeActivations_Value#getStates <em>States</em>}</li>
 * </ul>
 *
 * @see umlTrace.States.StatesPackage#getActivityNodeActivationGroup_nodeActivations_Value()
...
public interface ActivityNodeActivationGroup_nodeActivations_Value extends Value {
	 ...
	 * @see umlTrace.States.StatesPackage#getActivityNodeActivationGroup_nodeActivations_Value_NodeActivations()
	 * @model annotation="http://www.modelexecution.org/trace/XMOF executionMetamodelElement='//Activities/IntermediateActivities/ActivityNodeActivationGroup/nodeActivations'"
	 * @generated
	 */
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.fumlConfiguration.Activities.IntermediateActivities.TracedActivityNodeActivationGroup#getNodeActivationsSequence <em>Node Activations Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getActivityNodeActivationGroup_nodeActivations_Value_Parent()
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.ActivityNodeActivationGroup_nodeActivations_Value#getParent <em>Parent</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.State#getActivityNodeActivationGroup_nodeActivations_Values <em>Activity Node Activation Group node Activations Values</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getActivityNodeActivationGroup_nodeActivations_Value_States()
