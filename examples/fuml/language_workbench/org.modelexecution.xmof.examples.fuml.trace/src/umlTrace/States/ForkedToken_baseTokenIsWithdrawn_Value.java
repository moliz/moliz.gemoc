 ...
 * </p>
 * <ul>
 *   <li>{@link umlTrace.States.ForkedToken_baseTokenIsWithdrawn_Value#isBaseTokenIsWithdrawn <em>Base Token Is Withdrawn</em>}</li>
 *   <li>{@link umlTrace.States.ForkedToken_baseTokenIsWithdrawn_Value#getParent <em>Parent</em>}</li>
 *   <li>{@link umlTrace.States.ForkedToken_baseTokenIsWithdrawn_Value#getStates <em>States</em>}</li>
 * </ul>
 *
 * @see umlTrace.States.StatesPackage#getForkedToken_baseTokenIsWithdrawn_Value()
...
public interface ForkedToken_baseTokenIsWithdrawn_Value extends Value {
	 ...
	 * @see umlTrace.States.StatesPackage#getForkedToken_baseTokenIsWithdrawn_Value_BaseTokenIsWithdrawn()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.ForkedToken_baseTokenIsWithdrawn_Value#isBaseTokenIsWithdrawn <em>Base Token Is Withdrawn</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.fumlConfiguration.Activities.IntermediateActivities.TracedForkedToken#getBaseTokenIsWithdrawnSequence <em>Base Token Is Withdrawn Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getForkedToken_baseTokenIsWithdrawn_Value_Parent()
	...
	/**
	 * Sets the value of the '{@link umlTrace.States.ForkedToken_baseTokenIsWithdrawn_Value#getParent <em>Parent</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link umlTrace.States.State#getForkedToken_baseTokenIsWithdrawn_Values <em>Forked Token base Token Is Withdrawn Values</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see umlTrace.States.StatesPackage#getForkedToken_baseTokenIsWithdrawn_Value_States()
