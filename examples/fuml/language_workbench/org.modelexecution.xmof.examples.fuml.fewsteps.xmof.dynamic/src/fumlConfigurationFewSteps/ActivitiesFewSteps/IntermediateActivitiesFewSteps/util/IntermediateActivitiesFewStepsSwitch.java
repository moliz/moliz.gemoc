...
public class IntermediateActivitiesFewStepsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IntermediateActivitiesFewStepsPackage.ACTIVITY_EXECUTION: {
			...
			case IntermediateActivitiesFewStepsPackage.ACTIVITY_NODE_ACTIVATION_GROUP: {
			...
			case IntermediateActivitiesFewStepsPackage.ACTIVITY_PARAMETER_NODE_ACTIVATION: {
			...
			case IntermediateActivitiesFewStepsPackage.ACTIVITY_NODE_ACTIVATION: {
			...
			case IntermediateActivitiesFewStepsPackage.TOKEN: {
				Token token = (Token)theEObject;
				T result = caseToken(token);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IntermediateActivitiesFewStepsPackage.ACTIVITY_EDGE_INSTANCE: {
			...
			case IntermediateActivitiesFewStepsPackage.CONTROL_NODE_ACTIVATION: {
			...
			case IntermediateActivitiesFewStepsPackage.OBJECT_NODE_ACTIVATION: {
			...
			case IntermediateActivitiesFewStepsPackage.OFFER: {
				Offer offer = (Offer)theEObject;
				T result = caseOffer(offer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IntermediateActivitiesFewStepsPackage.DECISION_NODE_ACTIVATION: {
			...
			case IntermediateActivitiesFewStepsPackage.CONTROL_TOKEN: {
			...
			case IntermediateActivitiesFewStepsPackage.OBJECT_TOKEN: {
			...
			case IntermediateActivitiesFewStepsPackage.FORKED_TOKEN: {
			...
			case IntermediateActivitiesFewStepsPackage.INITIAL_NODE_ACTIVATION: {
			...
			case IntermediateActivitiesFewStepsPackage.MERGE_NODE_ACTIVATION: {
			...
			case IntermediateActivitiesFewStepsPackage.JOIN_NODE_ACTIVATION: {
			...
			case IntermediateActivitiesFewStepsPackage.FORK_NODE_ACTIVATION: {
			...
			case IntermediateActivitiesFewStepsPackage.ACTIVITY_FINAL_NODE_ACTIVATION: {
