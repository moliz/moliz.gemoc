 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationFewSteps.ActivitiesFewSteps.IntermediateActivitiesFewSteps.impl.ObjectNodeActivationImpl#getOfferedTokenCount <em>Offered Token Count</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ObjectNodeActivationImpl extends ActivityNodeActivationImpl implements ObjectNodeActivation {
	...
	protected EClass eStaticClass() {
		return IntermediateActivitiesFewStepsPackage.Literals.OBJECT_NODE_ACTIVATION;
	}
	...
	public void setOfferedTokenCount(int newOfferedTokenCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IntermediateActivitiesFewStepsPackage.OBJECT_NODE_ACTIVATION__OFFERED_TOKEN_COUNT, oldOfferedTokenCount, offeredTokenCount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IntermediateActivitiesFewStepsPackage.OBJECT_NODE_ACTIVATION__OFFERED_TOKEN_COUNT:
