...
import fumlConfigurationFewSteps.ActivitiesFewSteps.IntermediateActivitiesFewSteps.ForkedToken;
 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationFewSteps.ActivitiesFewSteps.IntermediateActivitiesFewSteps.impl.ForkedTokenImpl#getBaseToken <em>Base Token</em>}</li>
 *   <li>{@link fumlConfigurationFewSteps.ActivitiesFewSteps.IntermediateActivitiesFewSteps.impl.ForkedTokenImpl#getRemainingOffersCount <em>Remaining Offers Count</em>}</li>
 *   <li>{@link fumlConfigurationFewSteps.ActivitiesFewSteps.IntermediateActivitiesFewSteps.impl.ForkedTokenImpl#isBaseTokenIsWithdrawn <em>Base Token Is Withdrawn</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForkedTokenImpl extends TokenImpl implements ForkedToken {
	...
	protected EClass eStaticClass() {
		return IntermediateActivitiesFewStepsPackage.Literals.FORKED_TOKEN;
	}
		...
		if (baseToken != null && baseToken.eIsProxy()) {
			...
			if (baseToken != oldBaseToken) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IntermediateActivitiesFewStepsPackage.FORKED_TOKEN__BASE_TOKEN, oldBaseToken, baseToken));
			}
		}
		return baseToken;
	}
	...
	public void setBaseToken(Token newBaseToken) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IntermediateActivitiesFewStepsPackage.FORKED_TOKEN__BASE_TOKEN, oldBaseToken, baseToken));
	}
	...
	public void setRemainingOffersCount(int newRemainingOffersCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IntermediateActivitiesFewStepsPackage.FORKED_TOKEN__REMAINING_OFFERS_COUNT, oldRemainingOffersCount, remainingOffersCount));
	}
	...
	public void setBaseTokenIsWithdrawn(boolean newBaseTokenIsWithdrawn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IntermediateActivitiesFewStepsPackage.FORKED_TOKEN__BASE_TOKEN_IS_WITHDRAWN, oldBaseTokenIsWithdrawn, baseTokenIsWithdrawn));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IntermediateActivitiesFewStepsPackage.FORKED_TOKEN__BASE_TOKEN:
				if (resolve) return getBaseToken();
				return basicGetBaseToken();
			case IntermediateActivitiesFewStepsPackage.FORKED_TOKEN__REMAINING_OFFERS_COUNT:
				return getRemainingOffersCount();
			case IntermediateActivitiesFewStepsPackage.FORKED_TOKEN__BASE_TOKEN_IS_WITHDRAWN:
