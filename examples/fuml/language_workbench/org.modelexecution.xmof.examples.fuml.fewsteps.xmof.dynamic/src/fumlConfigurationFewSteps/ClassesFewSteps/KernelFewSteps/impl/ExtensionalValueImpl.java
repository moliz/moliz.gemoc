 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationFewSteps.ClassesFewSteps.KernelFewSteps.impl.ExtensionalValueImpl#getLocus_ExtensionalValue <em>Locus Extensional Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ExtensionalValueImpl extends CompoundValueImpl implements ExtensionalValue {
	...
	protected EClass eStaticClass() {
		return KernelFewStepsPackage.Literals.EXTENSIONAL_VALUE;
	}
	...
	public Locus getLocus_ExtensionalValue() {
		if (eContainerFeatureID() != KernelFewStepsPackage.EXTENSIONAL_VALUE__LOCUS_EXTENSIONAL_VALUE) return null;
	...
	public NotificationChain basicSetLocus_ExtensionalValue(Locus newLocus_ExtensionalValue, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newLocus_ExtensionalValue, KernelFewStepsPackage.EXTENSIONAL_VALUE__LOCUS_EXTENSIONAL_VALUE, msgs);
		return msgs;
	}
	...
	public void setLocus_ExtensionalValue(Locus newLocus_ExtensionalValue) {
		if (newLocus_ExtensionalValue != eInternalContainer() || (eContainerFeatureID() != KernelFewStepsPackage.EXTENSIONAL_VALUE__LOCUS_EXTENSIONAL_VALUE && newLocus_ExtensionalValue != null)) {
			...
			if (newLocus_ExtensionalValue != null)
				msgs = ((InternalEObject)newLocus_ExtensionalValue).eInverseAdd(this, LociFewStepsPackage.LOCUS__EXTENSIONAL_VALUES, Locus.class, msgs);
			msgs = basicSetLocus_ExtensionalValue(newLocus_ExtensionalValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelFewStepsPackage.EXTENSIONAL_VALUE__LOCUS_EXTENSIONAL_VALUE, newLocus_ExtensionalValue, newLocus_ExtensionalValue));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KernelFewStepsPackage.EXTENSIONAL_VALUE__LOCUS_EXTENSIONAL_VALUE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case KernelFewStepsPackage.EXTENSIONAL_VALUE__LOCUS_EXTENSIONAL_VALUE:
				return eInternalContainer().eInverseRemove(this, LociFewStepsPackage.LOCUS__EXTENSIONAL_VALUES, Locus.class, msgs);
		}
