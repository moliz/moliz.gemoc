...
public abstract class StructuredValueImpl extends ValueImpl implements StructuredValue {
	...
	protected EClass eStaticClass() {
		return KernelFewStepsPackage.Literals.STRUCTURED_VALUE;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case KernelFewStepsPackage.STRUCTURED_VALUE___CREATE_FEATURE_VALUES:
				createFeatureValues();
				return null;
			case KernelFewStepsPackage.STRUCTURED_VALUE___GET_FEATURE_VALUE__STRUCTURALFEATURE_FEATUREVALUE:
				getFeatureValue((StructuralFeature)arguments.get(0), (FeatureValue)arguments.get(1));
				return null;
			case KernelFewStepsPackage.STRUCTURED_VALUE___SET_FEATURE_VALUE__STRUCTURALFEATURE_ELIST_INT:
