...
public abstract class ValueImpl extends SemanticVisitorImpl implements Value {
	...
	protected EClass eStaticClass() {
		return KernelFewStepsPackage.Literals.VALUE;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case KernelFewStepsPackage.VALUE___GET_TYPES__ELIST:
				getTypes((EList<Classifier>)arguments.get(0));
				return null;
			case KernelFewStepsPackage.VALUE___COPY__VALUE:
				copy((Value)arguments.get(0));
				return null;
			case KernelFewStepsPackage.VALUE___NEW____VALUE:
				new_((Value)arguments.get(0));
				return null;
			case KernelFewStepsPackage.VALUE___EQUALS__VALUE_BOOLEAN:
				equals((Value)arguments.get(0), (Boolean)arguments.get(1));
				return null;
			case KernelFewStepsPackage.VALUE___HAS_TYPE__CLASSIFIER_BOOLEAN:
