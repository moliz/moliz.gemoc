 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationFewSteps.ClassesFewSteps.KernelFewSteps.impl.FeatureValueImpl#getFeature <em>Feature</em>}</li>
 *   <li>{@link fumlConfigurationFewSteps.ClassesFewSteps.KernelFewSteps.impl.FeatureValueImpl#getValues_FeatureValue <em>Values Feature Value</em>}</li>
 *   <li>{@link fumlConfigurationFewSteps.ClassesFewSteps.KernelFewSteps.impl.FeatureValueImpl#getPosition <em>Position</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class FeatureValueImpl extends MinimalEObjectImpl.Container implements FeatureValue {
	...
	protected EClass eStaticClass() {
		return KernelFewStepsPackage.Literals.FEATURE_VALUE;
	}
		...
		if (feature != null && feature.eIsProxy()) {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KernelFewStepsPackage.FEATURE_VALUE__FEATURE, oldFeature, feature));
			}
		}
		return feature;
	}
	...
	public void setFeature(StructuralFeature newFeature) {
		...
		feature = newFeature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelFewStepsPackage.FEATURE_VALUE__FEATURE, oldFeature, feature));
	}
	...
	public EList<Value> getValues_FeatureValue() {
		if (values_FeatureValue == null) {
			values_FeatureValue = new EObjectContainmentEList<Value>(Value.class, this, KernelFewStepsPackage.FEATURE_VALUE__VALUES_FEATURE_VALUE);
		}
	...
	public void setPosition(int newPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelFewStepsPackage.FEATURE_VALUE__POSITION, oldPosition, position));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KernelFewStepsPackage.FEATURE_VALUE__VALUES_FEATURE_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KernelFewStepsPackage.FEATURE_VALUE__FEATURE:
				if (resolve) return getFeature();
				return basicGetFeature();
			case KernelFewStepsPackage.FEATURE_VALUE__VALUES_FEATURE_VALUE:
				return getValues_FeatureValue();
			case KernelFewStepsPackage.FEATURE_VALUE__POSITION:
				return getPosition();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case KernelFewStepsPackage.FEATURE_VALUE___COPY__FEATUREVALUE:
