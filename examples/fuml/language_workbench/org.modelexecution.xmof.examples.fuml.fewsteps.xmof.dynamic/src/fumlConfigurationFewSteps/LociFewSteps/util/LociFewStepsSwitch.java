 ...
 * @generated
 */
public class LociFewStepsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LociFewStepsPackage.EXECUTION_ENVIRONMENT: {
			...
			case LociFewStepsPackage.LOCUS: {
				Locus locus = (Locus)theEObject;
				T result = caseLocus(locus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LociFewStepsPackage.EXECUTOR: {
				Executor executor = (Executor)theEObject;
				T result = caseExecutor(executor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LociFewStepsPackage.EXECUTION_FACTORY: {
				ExecutionFactory executionFactory = (ExecutionFactory)theEObject;
				T result = caseExecutionFactory(executionFactory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LociFewStepsPackage.SEMANTIC_VISITOR: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Execution Factory</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Execution Factory</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExecutionFactory(ExecutionFactory object) {
		return null;
	}
