 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationFewSteps.LociFewSteps.impl.SemanticVisitorImpl#getRuntimeModelElement <em>Runtime Model Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemanticVisitorImpl extends MinimalEObjectImpl.Container implements SemanticVisitor {
	...
	protected EClass eStaticClass() {
		return LociFewStepsPackage.Literals.SEMANTIC_VISITOR;
	}
		...
		if (runtimeModelElement != null && runtimeModelElement.eIsProxy()) {
			...
			if (runtimeModelElement != oldRuntimeModelElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LociFewStepsPackage.SEMANTIC_VISITOR__RUNTIME_MODEL_ELEMENT, oldRuntimeModelElement, runtimeModelElement));
			}
		}
	...
	public NotificationChain basicSetRuntimeModelElement(ElementConfiguration newRuntimeModelElement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LociFewStepsPackage.SEMANTIC_VISITOR__RUNTIME_MODEL_ELEMENT, oldRuntimeModelElement, newRuntimeModelElement);
	...
	public void setRuntimeModelElement(ElementConfiguration newRuntimeModelElement) {
		if (newRuntimeModelElement != runtimeModelElement) {
			...
			if (runtimeModelElement != null)
				msgs = ((InternalEObject)runtimeModelElement).eInverseRemove(this, FumlConfigurationFewStepsPackage.ELEMENT_CONFIGURATION__SEMANTIC_VISITOR, ElementConfiguration.class, msgs);
			if (newRuntimeModelElement != null)
				msgs = ((InternalEObject)newRuntimeModelElement).eInverseAdd(this, FumlConfigurationFewStepsPackage.ELEMENT_CONFIGURATION__SEMANTIC_VISITOR, ElementConfiguration.class, msgs);
			msgs = basicSetRuntimeModelElement(newRuntimeModelElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LociFewStepsPackage.SEMANTIC_VISITOR__RUNTIME_MODEL_ELEMENT, newRuntimeModelElement, newRuntimeModelElement));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LociFewStepsPackage.SEMANTIC_VISITOR__RUNTIME_MODEL_ELEMENT:
				if (runtimeModelElement != null)
					msgs = ((InternalEObject)runtimeModelElement).eInverseRemove(this, FumlConfigurationFewStepsPackage.ELEMENT_CONFIGURATION__SEMANTIC_VISITOR, ElementConfiguration.class, msgs);
