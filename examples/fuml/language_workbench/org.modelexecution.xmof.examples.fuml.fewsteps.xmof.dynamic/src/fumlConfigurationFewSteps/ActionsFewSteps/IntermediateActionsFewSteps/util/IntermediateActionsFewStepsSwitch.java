 ...
 * @generated
 */
public class IntermediateActionsFewStepsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public IntermediateActionsFewStepsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IntermediateActionsFewStepsPackage.VALUE_SPECIFICATION_ACTION_ACTIVATION: {
			...
			case IntermediateActionsFewStepsPackage.CREATE_OBJECT_ACTION_ACTIVATION: {
			...
			case IntermediateActionsFewStepsPackage.STRUCTURAL_FEATURE_ACTION_ACTIVATION: {
			...
			case IntermediateActionsFewStepsPackage.READ_STRUCTURAL_FEATURE_ACTION_ACTIVATION: {
			...
			case IntermediateActionsFewStepsPackage.WRITE_STRUCTURAL_FEATURE_ACTION_ACTIVATION: {
			...
			case IntermediateActionsFewStepsPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION_ACTIVATION: {
...
} //IntermediateActionsFewStepsSwitch
