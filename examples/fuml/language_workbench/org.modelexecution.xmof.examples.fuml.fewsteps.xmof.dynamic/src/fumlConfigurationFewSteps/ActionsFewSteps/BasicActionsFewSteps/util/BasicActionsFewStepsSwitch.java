...
public class BasicActionsFewStepsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BasicActionsFewStepsPackage.ACTION_ACTIVATION: {
			...
			case BasicActionsFewStepsPackage.PIN_ACTIVATION: {
			...
			case BasicActionsFewStepsPackage.INPUT_PIN_ACTIVATION: {
			...
			case BasicActionsFewStepsPackage.OPAQUE_ACTION_ACTIVATION: {
			...
			case BasicActionsFewStepsPackage.OUTPUT_PIN_ACTIVATION: {
			...
			case BasicActionsFewStepsPackage.CALL_ACTION_ACTIVATION: {
			...
			case BasicActionsFewStepsPackage.INVOCATION_ACTION_ACTIVATION: {
			...
			case BasicActionsFewStepsPackage.CALL_BEHAVIOR_ACTION_ACTIVATION: {
