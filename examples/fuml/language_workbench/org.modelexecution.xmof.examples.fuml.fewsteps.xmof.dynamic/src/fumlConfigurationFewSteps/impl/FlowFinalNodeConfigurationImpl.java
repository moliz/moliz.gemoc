...
import fumlConfigurationFewSteps.FlowFinalNodeConfiguration;
...
import org.eclipse.uml2.uml.internal.impl.FlowFinalNodeImpl;

/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Flow Final Node Configuration</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationFewSteps.impl.FlowFinalNodeConfigurationImpl#getSemanticVisitor <em>Semantic Visitor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FlowFinalNodeConfigurationImpl extends FlowFinalNodeImpl implements FlowFinalNodeConfiguration {
	/**
	 ...
	 * @generated
	 */
	protected FlowFinalNodeConfigurationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FumlConfigurationFewStepsPackage.eINSTANCE.getFlowFinalNodeConfiguration();
	}
	...
	public EList<SemanticVisitor> getSemanticVisitor() {
		if (semanticVisitor == null) {
			semanticVisitor = new EObjectWithInverseResolvingEList<SemanticVisitor>(SemanticVisitor.class, this, FumlConfigurationFewStepsPackage.FLOW_FINAL_NODE_CONFIGURATION__SEMANTIC_VISITOR, LociFewStepsPackage.SEMANTIC_VISITOR__RUNTIME_MODEL_ELEMENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FumlConfigurationFewStepsPackage.FLOW_FINAL_NODE_CONFIGURATION__SEMANTIC_VISITOR:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ElementConfiguration.class) {
			switch (derivedFeatureID) {
				case FumlConfigurationFewStepsPackage.FLOW_FINAL_NODE_CONFIGURATION__SEMANTIC_VISITOR: return FumlConfigurationFewStepsPackage.ELEMENT_CONFIGURATION__SEMANTIC_VISITOR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ElementConfiguration.class) {
			switch (baseFeatureID) {
				case FumlConfigurationFewStepsPackage.ELEMENT_CONFIGURATION__SEMANTIC_VISITOR: return FumlConfigurationFewStepsPackage.FLOW_FINAL_NODE_CONFIGURATION__SEMANTIC_VISITOR;
				default: return -1;
			}
		}
		if (baseClass == NamedElementConfiguration.class) {
...
} //FlowFinalNodeConfigurationImpl
