...
import fumlConfigurationFewSteps.OpaqueExpressionConfiguration;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Opaque Expression Configuration</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationFewSteps.impl.OpaqueExpressionConfigurationImpl#getSemanticVisitor <em>Semantic Visitor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OpaqueExpressionConfigurationImpl extends OpaqueExpressionImpl implements OpaqueExpressionConfiguration {
	/**
	 ...
	 * @generated
	 */
	protected OpaqueExpressionConfigurationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FumlConfigurationFewStepsPackage.eINSTANCE.getOpaqueExpressionConfiguration();
	}
	...
	public EList<SemanticVisitor> getSemanticVisitor() {
		if (semanticVisitor == null) {
			semanticVisitor = new EObjectWithInverseResolvingEList<SemanticVisitor>(SemanticVisitor.class, this, FumlConfigurationFewStepsPackage.OPAQUE_EXPRESSION_CONFIGURATION__SEMANTIC_VISITOR, LociFewStepsPackage.SEMANTIC_VISITOR__RUNTIME_MODEL_ELEMENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FumlConfigurationFewStepsPackage.OPAQUE_EXPRESSION_CONFIGURATION__SEMANTIC_VISITOR:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ElementConfiguration.class) {
			switch (derivedFeatureID) {
				case FumlConfigurationFewStepsPackage.OPAQUE_EXPRESSION_CONFIGURATION__SEMANTIC_VISITOR: return FumlConfigurationFewStepsPackage.ELEMENT_CONFIGURATION__SEMANTIC_VISITOR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ElementConfiguration.class) {
			switch (baseFeatureID) {
				case FumlConfigurationFewStepsPackage.ELEMENT_CONFIGURATION__SEMANTIC_VISITOR: return FumlConfigurationFewStepsPackage.OPAQUE_EXPRESSION_CONFIGURATION__SEMANTIC_VISITOR;
				default: return -1;
			}
		}
		if (baseClass == NamedElementConfiguration.class) {
...
} //OpaqueExpressionConfigurationImpl
