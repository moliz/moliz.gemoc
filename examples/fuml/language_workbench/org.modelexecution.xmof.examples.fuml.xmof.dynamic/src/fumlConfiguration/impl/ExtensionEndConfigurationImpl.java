...
import fumlConfiguration.ConnectableElementConfiguration;
import fumlConfiguration.DeploymentTargetConfiguration;
import fumlConfiguration.ElementConfiguration;
import fumlConfiguration.ExtensionEndConfiguration;
import fumlConfiguration.FeatureConfiguration;
import fumlConfiguration.FumlConfigurationPackage;
import fumlConfiguration.MultiplicityElementConfiguration;
import fumlConfiguration.NamedElementConfiguration;
import fumlConfiguration.ParameterableElementConfiguration;
import fumlConfiguration.PropertyConfiguration;
import fumlConfiguration.RedefinableElementConfiguration;
import fumlConfiguration.StructuralFeatureConfiguration;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Extension End Configuration</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fumlConfiguration.impl.ExtensionEndConfigurationImpl#getSemanticVisitor <em>Semantic Visitor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExtensionEndConfigurationImpl extends ExtensionEndImpl implements ExtensionEndConfiguration {
	/**
	 ...
	 * @generated
	 */
	protected ExtensionEndConfigurationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FumlConfigurationPackage.eINSTANCE.getExtensionEndConfiguration();
	}
	...
	public EList<SemanticVisitor> getSemanticVisitor() {
		if (semanticVisitor == null) {
			semanticVisitor = new EObjectWithInverseResolvingEList<SemanticVisitor>(SemanticVisitor.class, this, FumlConfigurationPackage.EXTENSION_END_CONFIGURATION__SEMANTIC_VISITOR, LociPackage.SEMANTIC_VISITOR__RUNTIME_MODEL_ELEMENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FumlConfigurationPackage.EXTENSION_END_CONFIGURATION__SEMANTIC_VISITOR:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ElementConfiguration.class) {
			switch (derivedFeatureID) {
				case FumlConfigurationPackage.EXTENSION_END_CONFIGURATION__SEMANTIC_VISITOR: return FumlConfigurationPackage.ELEMENT_CONFIGURATION__SEMANTIC_VISITOR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ElementConfiguration.class) {
			switch (baseFeatureID) {
				case FumlConfigurationPackage.ELEMENT_CONFIGURATION__SEMANTIC_VISITOR: return FumlConfigurationPackage.EXTENSION_END_CONFIGURATION__SEMANTIC_VISITOR;
				default: return -1;
			}
		}
		if (baseClass == NamedElementConfiguration.class) {
