...
public abstract class CallActionActivationImpl extends InvocationActionActivationImpl implements CallActionActivation {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case BasicActionsPackage.CALL_ACTION_ACTIVATION___GET_CALL_EXECUTION__EXECUTION:
				getCallExecution((Execution)arguments.get(0));
				return null;
			case BasicActionsPackage.CALL_ACTION_ACTIVATION___REMOVE_CALL_EXECUTION__EXECUTION:
				removeCallExecution((Execution)arguments.get(0));
				return null;
			case BasicActionsPackage.CALL_ACTION_ACTIVATION___INITIALIZE_INPUT_PARAMETER_VALUES__EXECUTION:
				initializeInputParameterValues((Execution)arguments.get(0));
				return null;
			case BasicActionsPackage.CALL_ACTION_ACTIVATION___COLLECT_OUTPUT_PARAMETER_VALUES__EXECUTION:
