 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationFewStepsTrace.States.impl.SemanticVisitor_runtimeModelElement_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link fumlConfigurationFewStepsTrace.States.impl.SemanticVisitor_runtimeModelElement_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fumlConfigurationFewStepsTrace.States.impl.SemanticVisitor_runtimeModelElement_ValueImpl#getRuntimeModelElement <em>Runtime Model Element</em>}</li>
 *   <li>{@link fumlConfigurationFewStepsTrace.States.impl.SemanticVisitor_runtimeModelElement_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemanticVisitor_runtimeModelElement_ValueImpl extends MinimalEObjectImpl.Container implements SemanticVisitor_runtimeModelElement_Value {
	...
	public void setParent(TracedSemanticVisitor newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.SEMANTIC_VISITOR_RUNTIME_MODEL_ELEMENT_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, LociFewStepsPackage.TRACED_SEMANTIC_VISITOR__RUNTIME_MODEL_ELEMENT_SEQUENCE, TracedSemanticVisitor.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.SEMANTIC_VISITOR_RUNTIME_MODEL_ELEMENT_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, LociFewStepsPackage.TRACED_SEMANTIC_VISITOR__RUNTIME_MODEL_ELEMENT_SEQUENCE, TracedSemanticVisitor.class, msgs);
		}
