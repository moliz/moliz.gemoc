/**
 */
package fumlConfiguration.CommonBehaviors.BasicBehaviors.util;
...
import fumlConfiguration.CommonBehaviors.BasicBehaviors.*;
 ...
 * <!-- end-user-doc -->
 * @see fumlConfiguration.CommonBehaviors.BasicBehaviors.BasicBehaviorsPackage
 * @generated
 */
public class BasicBehaviorsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BasicBehaviorsPackage.EXECUTION: {
				Execution execution = (Execution)theEObject;
				T result = caseExecution(execution);
				if (result == null) result = caseObject(execution);
				if (result == null) result = caseExtensionalValue(execution);
				if (result == null) result = caseCompoundValue(execution);
				if (result == null) result = caseStructuredValue(execution);
				if (result == null) result = caseValue(execution);
				if (result == null) result = caseSemanticVisitor(execution);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicBehaviorsPackage.OPAQUE_BEHAVIOR_EXECUTION: {
				OpaqueBehaviorExecution opaqueBehaviorExecution = (OpaqueBehaviorExecution)theEObject;
				T result = caseOpaqueBehaviorExecution(opaqueBehaviorExecution);
				if (result == null) result = caseExecution(opaqueBehaviorExecution);
				if (result == null) result = caseObject(opaqueBehaviorExecution);
				if (result == null) result = caseExtensionalValue(opaqueBehaviorExecution);
				if (result == null) result = caseCompoundValue(opaqueBehaviorExecution);
				if (result == null) result = caseStructuredValue(opaqueBehaviorExecution);
				if (result == null) result = caseValue(opaqueBehaviorExecution);
				if (result == null) result = caseSemanticVisitor(opaqueBehaviorExecution);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
