...
public interface BooleanValue extends PrimitiveValue {
	 ...
	 * @see fumlConfiguration.Classes.Kernel.KernelPackage#getBooleanValue_Value_BooleanValue()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link fumlConfiguration.Classes.Kernel.BooleanValue#isValue_BooleanValue <em>Value Boolean Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
