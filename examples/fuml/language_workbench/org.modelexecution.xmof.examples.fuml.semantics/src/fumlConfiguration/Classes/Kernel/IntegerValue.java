...
public interface IntegerValue extends PrimitiveValue {
	 ...
	 * @see fumlConfiguration.Classes.Kernel.KernelPackage#getIntegerValue_Value_IntegerValue()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link fumlConfiguration.Classes.Kernel.IntegerValue#getValue_IntegerValue <em>Value Integer Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
