 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationFewStepsTrace.States.fumlConfigurationFewSteps.LociFewSteps.impl.TracedSemanticVisitorImpl#getRuntimeModelElementSequence <em>Runtime Model Element Sequence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TracedSemanticVisitorImpl extends MinimalEObjectImpl.Container implements TracedSemanticVisitor {
	...
	protected EClass eStaticClass() {
		return LociFewStepsPackage.Literals.TRACED_SEMANTIC_VISITOR;
	}
	...
	public EList<SemanticVisitor_runtimeModelElement_Value> getRuntimeModelElementSequence() {
		if (runtimeModelElementSequence == null) {
			runtimeModelElementSequence = new EObjectContainmentWithInverseEList<SemanticVisitor_runtimeModelElement_Value>(SemanticVisitor_runtimeModelElement_Value.class, this, LociFewStepsPackage.TRACED_SEMANTIC_VISITOR__RUNTIME_MODEL_ELEMENT_SEQUENCE, StatesPackage.SEMANTIC_VISITOR_RUNTIME_MODEL_ELEMENT_VALUE__PARENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LociFewStepsPackage.TRACED_SEMANTIC_VISITOR__RUNTIME_MODEL_ELEMENT_SEQUENCE:
