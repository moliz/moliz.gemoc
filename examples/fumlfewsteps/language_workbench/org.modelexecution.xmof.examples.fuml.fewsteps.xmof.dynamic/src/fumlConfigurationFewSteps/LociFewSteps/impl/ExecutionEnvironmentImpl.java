 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationFewSteps.LociFewSteps.impl.ExecutionEnvironmentImpl#getLocus_ExecutionEnvironment <em>Locus Execution Environment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExecutionEnvironmentImpl extends MinimalEObjectImpl.Container implements ExecutionEnvironment {
	...
	protected EClass eStaticClass() {
		return LociFewStepsPackage.Literals.EXECUTION_ENVIRONMENT;
	}
	...
	public NotificationChain basicSetLocus_ExecutionEnvironment(Locus newLocus_ExecutionEnvironment, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LociFewStepsPackage.EXECUTION_ENVIRONMENT__LOCUS_EXECUTION_ENVIRONMENT, oldLocus_ExecutionEnvironment, newLocus_ExecutionEnvironment);
	...
	public void setLocus_ExecutionEnvironment(Locus newLocus_ExecutionEnvironment) {
		if (newLocus_ExecutionEnvironment != locus_ExecutionEnvironment) {
			...
			if (locus_ExecutionEnvironment != null)
				msgs = ((InternalEObject)locus_ExecutionEnvironment).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LociFewStepsPackage.EXECUTION_ENVIRONMENT__LOCUS_EXECUTION_ENVIRONMENT, null, msgs);
			if (newLocus_ExecutionEnvironment != null)
				msgs = ((InternalEObject)newLocus_ExecutionEnvironment).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LociFewStepsPackage.EXECUTION_ENVIRONMENT__LOCUS_EXECUTION_ENVIRONMENT, null, msgs);
			msgs = basicSetLocus_ExecutionEnvironment(newLocus_ExecutionEnvironment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LociFewStepsPackage.EXECUTION_ENVIRONMENT__LOCUS_EXECUTION_ENVIRONMENT, newLocus_ExecutionEnvironment, newLocus_ExecutionEnvironment));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LociFewStepsPackage.EXECUTION_ENVIRONMENT__LOCUS_EXECUTION_ENVIRONMENT:
