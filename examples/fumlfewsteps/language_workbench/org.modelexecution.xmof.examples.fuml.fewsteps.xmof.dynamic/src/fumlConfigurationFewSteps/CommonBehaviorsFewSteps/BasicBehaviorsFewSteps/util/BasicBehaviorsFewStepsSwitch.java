 ...
 * @generated
 */
public class BasicBehaviorsFewStepsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public BasicBehaviorsFewStepsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BasicBehaviorsFewStepsPackage.EXECUTION: {
			...
			case BasicBehaviorsFewStepsPackage.OPAQUE_BEHAVIOR_EXECUTION: {
			...
			case BasicBehaviorsFewStepsPackage.PARAMETER_VALUE: {
