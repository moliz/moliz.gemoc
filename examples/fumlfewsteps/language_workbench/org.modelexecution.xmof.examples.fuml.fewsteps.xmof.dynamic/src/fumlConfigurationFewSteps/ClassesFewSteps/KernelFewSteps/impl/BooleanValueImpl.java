 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationFewSteps.ClassesFewSteps.KernelFewSteps.impl.BooleanValueImpl#isValue_BooleanValue <em>Value Boolean Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanValueImpl extends PrimitiveValueImpl implements BooleanValue {
	...
	protected EClass eStaticClass() {
		return KernelFewStepsPackage.Literals.BOOLEAN_VALUE;
	}
	...
	public void setValue_BooleanValue(boolean newValue_BooleanValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelFewStepsPackage.BOOLEAN_VALUE__VALUE_BOOLEAN_VALUE, oldValue_BooleanValue, value_BooleanValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KernelFewStepsPackage.BOOLEAN_VALUE__VALUE_BOOLEAN_VALUE:
