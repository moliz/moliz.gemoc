 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationFewSteps.ClassesFewSteps.KernelFewSteps.impl.PrimitiveValueImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PrimitiveValueImpl extends ValueImpl implements PrimitiveValue {
	...
	protected EClass eStaticClass() {
		return KernelFewStepsPackage.Literals.PRIMITIVE_VALUE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KernelFewStepsPackage.PRIMITIVE_VALUE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(PrimitiveType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelFewStepsPackage.PRIMITIVE_VALUE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KernelFewStepsPackage.PRIMITIVE_VALUE__TYPE:
