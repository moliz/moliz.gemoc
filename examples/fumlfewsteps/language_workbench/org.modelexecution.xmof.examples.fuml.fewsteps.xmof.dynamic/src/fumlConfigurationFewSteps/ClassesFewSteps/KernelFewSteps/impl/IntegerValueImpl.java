 ...
 * </p>
 * <ul>
 *   <li>{@link fumlConfigurationFewSteps.ClassesFewSteps.KernelFewSteps.impl.IntegerValueImpl#getValue_IntegerValue <em>Value Integer Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerValueImpl extends PrimitiveValueImpl implements IntegerValue {
	...
	protected EClass eStaticClass() {
		return KernelFewStepsPackage.Literals.INTEGER_VALUE;
	}
	...
	public void setValue_IntegerValue(int newValue_IntegerValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelFewStepsPackage.INTEGER_VALUE__VALUE_INTEGER_VALUE, oldValue_IntegerValue, value_IntegerValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KernelFewStepsPackage.INTEGER_VALUE__VALUE_INTEGER_VALUE:
