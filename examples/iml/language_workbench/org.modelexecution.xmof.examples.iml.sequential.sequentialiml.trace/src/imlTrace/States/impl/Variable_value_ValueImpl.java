 ...
 * </p>
 * <ul>
 *   <li>{@link imlTrace.States.impl.Variable_value_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link imlTrace.States.impl.Variable_value_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link imlTrace.States.impl.Variable_value_ValueImpl#getStates <em>States</em>}</li>
 *   <li>{@link imlTrace.States.impl.Variable_value_ValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Variable_value_ValueImpl extends MinimalEObjectImpl.Container implements Variable_value_Value {
	...
	public void setParent(TracedVariable newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.VARIABLE_VALUE_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, ImlPackage.TRACED_VARIABLE__VALUE_SEQUENCE, TracedVariable.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.VARIABLE_VALUE_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, ImlPackage.TRACED_VARIABLE__VALUE_SEQUENCE, TracedVariable.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatesPackage.VARIABLE_VALUE_VALUE__STATES_NO_OPPOSITE:
