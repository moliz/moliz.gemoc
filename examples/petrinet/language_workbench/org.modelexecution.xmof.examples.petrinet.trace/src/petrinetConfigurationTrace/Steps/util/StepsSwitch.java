...
public class StepsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_MAIN: {
				PetrinetConfiguration_NetConfiguration_Main petrinetConfiguration_NetConfiguration_Main = (PetrinetConfiguration_NetConfiguration_Main)theEObject;
				T result = casePetrinetConfiguration_NetConfiguration_Main(petrinetConfiguration_NetConfiguration_Main);
				if (result == null) result = caseSpecificStep(petrinetConfiguration_NetConfiguration_Main);
				if (result == null) result = caseSequentialStep(petrinetConfiguration_NetConfiguration_Main);
				if (result == null) result = caseBigStep(petrinetConfiguration_NetConfiguration_Main);
				if (result == null) result = caseStep(petrinetConfiguration_NetConfiguration_Main);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_MAIN_ABSTRACT_SUB_STEP: {
				PetrinetConfiguration_NetConfiguration_Main_AbstractSubStep petrinetConfiguration_NetConfiguration_Main_AbstractSubStep = (PetrinetConfiguration_NetConfiguration_Main_AbstractSubStep)theEObject;
				T result = casePetrinetConfiguration_NetConfiguration_Main_AbstractSubStep(petrinetConfiguration_NetConfiguration_Main_AbstractSubStep);
				if (result == null) result = caseSpecificStep(petrinetConfiguration_NetConfiguration_Main_AbstractSubStep);
				if (result == null) result = caseStep(petrinetConfiguration_NetConfiguration_Main_AbstractSubStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_MAIN_IMPLICIT_STEP: {
				PetrinetConfiguration_NetConfiguration_Main_ImplicitStep petrinetConfiguration_NetConfiguration_Main_ImplicitStep = (PetrinetConfiguration_NetConfiguration_Main_ImplicitStep)theEObject;
				T result = casePetrinetConfiguration_NetConfiguration_Main_ImplicitStep(petrinetConfiguration_NetConfiguration_Main_ImplicitStep);
				if (result == null) result = casePetrinetConfiguration_NetConfiguration_Main_AbstractSubStep(petrinetConfiguration_NetConfiguration_Main_ImplicitStep);
				if (result == null) result = caseSmallStep(petrinetConfiguration_NetConfiguration_Main_ImplicitStep);
				if (result == null) result = caseSpecificStep(petrinetConfiguration_NetConfiguration_Main_ImplicitStep);
				if (result == null) result = caseStep(petrinetConfiguration_NetConfiguration_Main_ImplicitStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN: {
				...
				if (result == null) result = casePetrinetConfiguration_NetConfiguration_Main_AbstractSubStep(petrinetConfiguration_NetConfiguration_Run);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Petrinet Configuration Net Configuration Main</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Petrinet Configuration Net Configuration Main</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePetrinetConfiguration_NetConfiguration_Main(PetrinetConfiguration_NetConfiguration_Main object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Petrinet Configuration Net Configuration Main Abstract Sub Step</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Petrinet Configuration Net Configuration Main Abstract Sub Step</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePetrinetConfiguration_NetConfiguration_Main_AbstractSubStep(PetrinetConfiguration_NetConfiguration_Main_AbstractSubStep object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Petrinet Configuration Net Configuration Main Implicit Step</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Petrinet Configuration Net Configuration Main Implicit Step</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePetrinetConfiguration_NetConfiguration_Main_ImplicitStep(PetrinetConfiguration_NetConfiguration_Main_ImplicitStep object) {
		return null;
	}
