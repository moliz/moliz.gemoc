 ...
 * </p>
 * <ul>
 *   <li>{@link petrinetConfigurationTrace.Steps.impl.PetrinetConfiguration_NetConfiguration_RunImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link petrinetConfigurationTrace.Steps.impl.PetrinetConfiguration_NetConfiguration_RunImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link petrinetConfigurationTrace.Steps.impl.PetrinetConfiguration_NetConfiguration_RunImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PetrinetConfiguration_NetConfiguration_RunImpl extends StepImpl implements PetrinetConfiguration_NetConfiguration_Run {
	...
	public EList<PetrinetConfiguration_NetConfiguration_Run_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectContainmentEList<PetrinetConfiguration_NetConfiguration_Run_AbstractSubStep>(Step.class, this, StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN__SUB_STEPS);
		}
		return subSteps;
	}
