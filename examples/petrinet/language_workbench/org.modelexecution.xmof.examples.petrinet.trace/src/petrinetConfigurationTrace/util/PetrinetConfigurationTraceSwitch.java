 ...
 * @generated
 */
public class PetrinetConfigurationTraceSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public PetrinetConfigurationTraceSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PetrinetConfigurationTracePackage.SPECIFIC_TRACE: {
...
} //PetrinetConfigurationTraceSwitch
