...
public class PetrinetConfigurationAdapterFactory extends AdapterFactoryImpl {
	...
	protected PetrinetConfigurationSwitch<Adapter> modelSwitch =
		new PetrinetConfigurationSwitch<Adapter>() {
			@Override
			public Adapter caseTracedPlaceConfiguration(TracedPlaceConfiguration object) {
				return createTracedPlaceConfigurationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link petrinetConfigurationTrace.States.petrinetConfiguration.TracedPlaceConfiguration <em>Traced Place Configuration</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTracedPlaceConfigurationAdapter() {
		return null;
	}
