...
public class StatesFactoryImpl extends EFactoryImpl implements StatesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case StatesPackage.PLACE_CONFIGURATION_TOKENS_VALUE: return createPlaceConfiguration_tokens_Value();
	 ...
	 * @generated
	 */
	public PlaceConfiguration_tokens_Value createPlaceConfiguration_tokens_Value() {
		PlaceConfiguration_tokens_ValueImpl placeConfiguration_tokens_Value = new PlaceConfiguration_tokens_ValueImpl();
		return placeConfiguration_tokens_Value;
	}
