 ...
 * </p>
 * <ul>
 *   <li>{@link petrinetConfigurationTrace.States.impl.StateImpl#getEndedSteps <em>Ended Steps</em>}</li>
 *   <li>{@link petrinetConfigurationTrace.States.impl.StateImpl#getPlaceConfiguration_tokens_Values <em>Place Configuration tokens Values</em>}</li>
 *   <li>{@link petrinetConfigurationTrace.States.impl.StateImpl#getStartedSteps <em>Started Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateImpl extends MinimalEObjectImpl.Container implements State {
	...
	/**
	 * The cached value of the '{@link #getPlaceConfiguration_tokens_Values() <em>Place Configuration tokens Values</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPlaceConfiguration_tokens_Values()
	 * @generated
	 * @ordered
	 */
	protected EList<PlaceConfiguration_tokens_Value> placeConfiguration_tokens_Values;
	 ...
	 * @generated
	 */
	public EList<PlaceConfiguration_tokens_Value> getPlaceConfiguration_tokens_Values() {
		if (placeConfiguration_tokens_Values == null) {
			placeConfiguration_tokens_Values = new EObjectWithInverseResolvingEList.ManyInverse<PlaceConfiguration_tokens_Value>(PlaceConfiguration_tokens_Value.class, this, StatesPackage.STATE__PLACE_CONFIGURATION_TOKENS_VALUES, StatesPackage.PLACE_CONFIGURATION_TOKENS_VALUE__STATES);
		}
		return placeConfiguration_tokens_Values;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StatesPackage.STATE__PLACE_CONFIGURATION_TOKENS_VALUES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getPlaceConfiguration_tokens_Values()).basicAdd(otherEnd, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StatesPackage.STATE__PLACE_CONFIGURATION_TOKENS_VALUES:
				return ((InternalEList<?>)getPlaceConfiguration_tokens_Values()).basicRemove(otherEnd, msgs);
			case StatesPackage.STATE__STARTED_STEPS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case StatesPackage.STATE__PLACE_CONFIGURATION_TOKENS_VALUES:
				return getPlaceConfiguration_tokens_Values();
			case StatesPackage.STATE__STARTED_STEPS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case StatesPackage.STATE__ENDED_STEPS:
				...
				return;
			case StatesPackage.STATE__PLACE_CONFIGURATION_TOKENS_VALUES:
				getPlaceConfiguration_tokens_Values().clear();
				getPlaceConfiguration_tokens_Values().addAll((Collection<? extends PlaceConfiguration_tokens_Value>)newValue);
				return;
			case StatesPackage.STATE__STARTED_STEPS:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case StatesPackage.STATE__PLACE_CONFIGURATION_TOKENS_VALUES:
				return placeConfiguration_tokens_Values != null && !placeConfiguration_tokens_Values.isEmpty();
			case StatesPackage.STATE__STARTED_STEPS:
