...
import petrinetConfigurationTrace.States.StatesFactory;
import petrinetConfigurationTrace.States.StatesPackage;
import petrinetConfigurationTrace.States.Value;
...
public class StatesPackageImpl extends EPackageImpl implements StatesPackage {
	 ...
	 * @see petrinetConfigurationTrace.States.StatesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		addEOperation(placeConfiguration_tokens_ValueEClass, this.getState(), "getStatesNoOpposite", 1, -1, IS_UNIQUE, IS_ORDERED);
