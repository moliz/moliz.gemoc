...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Petrinet Configuration Transition Configuration Fire</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link petrinetTrace.Steps.impl.PetrinetConfiguration_TransitionConfiguration_FireImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link petrinetTrace.Steps.impl.PetrinetConfiguration_TransitionConfiguration_FireImpl#getStartingState <em>Starting State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PetrinetConfiguration_TransitionConfiguration_FireImpl extends StepImpl implements PetrinetConfiguration_TransitionConfiguration_Fire {
	/**
	 ...
	 * @generated
	 */
	protected PetrinetConfiguration_TransitionConfiguration_FireImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.PETRINET_CONFIGURATION_TRANSITION_CONFIGURATION_FIRE;
	}
		...
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.PETRINET_CONFIGURATION_TRANSITION_CONFIGURATION_FIRE__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINET_CONFIGURATION_TRANSITION_CONFIGURATION_FIRE__ENDING_STATE, oldEndingState, newEndingState);
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINET_CONFIGURATION_TRANSITION_CONFIGURATION_FIRE__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.PETRINET_CONFIGURATION_TRANSITION_CONFIGURATION_FIRE__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINET_CONFIGURATION_TRANSITION_CONFIGURATION_FIRE__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINET_CONFIGURATION_TRANSITION_CONFIGURATION_FIRE__STARTING_STATE, newStartingState, newStartingState));
	}
	...
	public TransitionConfiguration getCaller() {
		return (petrinetConfiguration.TransitionConfiguration) this.getMseoccurrence().getMse().getCaller();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.PETRINET_CONFIGURATION_TRANSITION_CONFIGURATION_FIRE__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.PETRINET_CONFIGURATION_TRANSITION_CONFIGURATION_FIRE__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case StepsPackage.PETRINET_CONFIGURATION_TRANSITION_CONFIGURATION_FIRE___GET_CALLER:
				return getCaller();
		}
		return super.eInvoke(operationID, arguments);
	}

} //PetrinetConfiguration_TransitionConfiguration_FireImpl
