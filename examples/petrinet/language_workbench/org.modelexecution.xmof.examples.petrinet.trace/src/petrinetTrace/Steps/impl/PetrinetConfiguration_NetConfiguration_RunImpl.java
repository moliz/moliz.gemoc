...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Petrinet Configuration Net Configuration Run</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link petrinetTrace.Steps.impl.PetrinetConfiguration_NetConfiguration_RunImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link petrinetTrace.Steps.impl.PetrinetConfiguration_NetConfiguration_RunImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link petrinetTrace.Steps.impl.PetrinetConfiguration_NetConfiguration_RunImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PetrinetConfiguration_NetConfiguration_RunImpl extends StepImpl implements PetrinetConfiguration_NetConfiguration_Run {
	/**
	 ...
	 * @ordered
	 */
	protected EList<PetrinetConfiguration_NetConfiguration_Run_AbstractSubStep> subSteps;
	 ...
	 * @generated
	 */
	protected PetrinetConfiguration_NetConfiguration_RunImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN;
	}
		...
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN__ENDING_STATE, oldEndingState, newEndingState);
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN__STARTING_STATE, newStartingState, newStartingState));
	}
	 ...
	 * @generated
	 */
	public EList<PetrinetConfiguration_NetConfiguration_Run_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectContainmentEList<PetrinetConfiguration_NetConfiguration_Run_AbstractSubStep>(PetrinetConfiguration_NetConfiguration_Run_AbstractSubStep.class, this, StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN__SUB_STEPS);
		}
		return subSteps;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN__SUB_STEPS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN__SUB_STEPS:
				getSubSteps().clear();
				getSubSteps().addAll((Collection<? extends PetrinetConfiguration_NetConfiguration_Run_AbstractSubStep>)newValue);
				return;
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case StepsPackage.PETRINET_CONFIGURATION_NET_CONFIGURATION_RUN___GET_CALLER:
				return getCaller();
		}
		return super.eInvoke(operationID, arguments);
	}

} //PetrinetConfiguration_NetConfiguration_RunImpl
