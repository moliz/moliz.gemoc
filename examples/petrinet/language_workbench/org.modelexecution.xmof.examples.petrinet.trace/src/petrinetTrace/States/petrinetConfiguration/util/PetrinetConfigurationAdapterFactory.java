...
public class PetrinetConfigurationAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link petrinetTrace.States.petrinetConfiguration.TracedPlaceConfiguration <em>Traced Place Configuration</em>}'.
	 * <!-- begin-user-doc -->
