...
public class FsmConfigurationAdapterFactory extends AdapterFactoryImpl {
	...
	protected FsmConfigurationSwitch<Adapter> modelSwitch =
		new FsmConfigurationSwitch<Adapter>() {
			@Override
			public Adapter caseFSMConfiguration(FSMConfiguration object) {
				return createFSMConfigurationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fsmConfiguration.FSMConfiguration <em>FSM Configuration</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFSMConfigurationAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link fsmConfiguration.StateConfiguration <em>State Configuration</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fsmConfiguration.TransitionConfiguration <em>Transition Configuration</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fsmConfiguration.Input <em>Input</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
