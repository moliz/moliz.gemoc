...
public class FsmConfigurationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FsmConfigurationPackage.FSM_CONFIGURATION: {
				FSMConfiguration fsmConfiguration = (FSMConfiguration)theEObject;
				T result = caseFSMConfiguration(fsmConfiguration);
				if (result == null) result = caseFSM(fsmConfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FsmConfigurationPackage.STATE_CONFIGURATION: {
			...
			case FsmConfigurationPackage.TRANSITION_CONFIGURATION: {
			...
			case FsmConfigurationPackage.INPUT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>FSM Configuration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>FSM Configuration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFSMConfiguration(FSMConfiguration object) {
		return null;
	}
