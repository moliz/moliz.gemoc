 ...
 * </p>
 * <ul>
 *   <li>{@link fsmConfiguration.impl.StringLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringLiteralImpl extends MinimalEObjectImpl.Container implements StringLiteral {
	...
	protected EClass eStaticClass() {
		return FsmConfigurationPackage.Literals.STRING_LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmConfigurationPackage.STRING_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FsmConfigurationPackage.STRING_LITERAL__VALUE:
				return getValue();
		}
