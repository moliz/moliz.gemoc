 ...
 * @generated
 */
public class FsmConfigurationTraceSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public FsmConfigurationTraceSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FsmConfigurationTracePackage.SPECIFIC_TRACE: {
