...
public class FsmSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FsmPackage.TRACED_FSM: {
				TracedFSM tracedFSM = (TracedFSM)theEObject;
				T result = caseTracedFSM(tracedFSM);
				if (result == null) result = caseSpecificTracedObject(tracedFSM);
				if (result == null) result = caseTracedObject(tracedFSM);
