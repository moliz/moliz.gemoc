...
public class FSMImpl extends MinimalEObjectImpl.Container implements FSM {
	...
	public EList<State> getStates() {
		if (states == null) {
			states = new EObjectContainmentWithInverseEList<State>(State.class, this, FsmPackage.FSM__STATES, FsmPackage.STATE__CONTAINING_FSM);
		}
		return states;
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentWithInverseEList<Transition>(Transition.class, this, FsmPackage.FSM__TRANSITIONS, FsmPackage.TRANSITION__CONTAINING_FSM);
		}
		return transitions;
	}
