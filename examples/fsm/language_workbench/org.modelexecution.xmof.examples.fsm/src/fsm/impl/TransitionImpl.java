 ...
 *   <li>{@link fsm.impl.TransitionImpl#getContainingFSM <em>Containing FSM</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	 ...
	 * @generated
	 */
	public FSM getContainingFSM() {
		if (eContainerFeatureID() != FsmPackage.TRANSITION__CONTAINING_FSM) return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetContainingFSM(FSM newContainingFSM, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newContainingFSM, FsmPackage.TRANSITION__CONTAINING_FSM, msgs);
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setContainingFSM(FSM newContainingFSM) {
		if (newContainingFSM != eInternalContainer() || (eContainerFeatureID() != FsmPackage.TRANSITION__CONTAINING_FSM && newContainingFSM != null)) {
			if (EcoreUtil.isAncestor(this, newContainingFSM))
				throw new IllegalArgumentException("Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			if (newContainingFSM != null)
				msgs = ((InternalEObject)newContainingFSM).eInverseAdd(this, FsmPackage.FSM__TRANSITIONS, FSM.class, msgs);
			msgs = basicSetContainingFSM(newContainingFSM, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.TRANSITION__CONTAINING_FSM, newContainingFSM, newContainingFSM));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FsmPackage.TRANSITION__CONTAINING_FSM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetContainingFSM((FSM)otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FsmPackage.TRANSITION__CONTAINING_FSM:
				return basicSetContainingFSM(null, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case FsmPackage.TRANSITION__CONTAINING_FSM:
				return eInternalContainer().eInverseRemove(this, FsmPackage.FSM__TRANSITIONS, FSM.class, msgs);
		}
