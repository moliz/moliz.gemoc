...
public class Petrinet2ConfigurationPackageImpl extends EPackageImpl implements
	 ...
	 * {@link Petrinet2ConfigurationPackage#eINSTANCE} when that field is
	...
	public static Petrinet2ConfigurationPackage init() {
		if (isInited)
			return (Petrinet2ConfigurationPackage) EPackage.Registry.INSTANCE
					.getEPackage(Petrinet2ConfigurationPackage.eNS_URI);

		// Obtain or create and register package
		Petrinet2ConfigurationPackageImpl thePetrinet2ConfigurationPackage = (Petrinet2ConfigurationPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof Petrinet2ConfigurationPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new Petrinet2ConfigurationPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(Petrinet2ConfigurationPackage.eNS_URI,
				thePetrinet2ConfigurationPackage);
	...
	public EReference getPlaceConfiguration_HeldTokens() {
		return (EReference) placeConfigurationEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getTokenDistribution_InitialTokens() {
		return (EReference) tokenDistributionEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(netConfigurationEClass,
				NET_CONFIGURATION___MAIN__ELIST);
		createEOperation(netConfigurationEClass,
				NET_CONFIGURATION___INITIALIZE_MARKING__ELIST);

		placeConfigurationEClass = createEClass(PLACE_CONFIGURATION);
		createEReference(placeConfigurationEClass,
				PLACE_CONFIGURATION__HELD_TOKENS);
		createEOperation(placeConfigurationEClass,
				PLACE_CONFIGURATION___ADD_TOKEN);
		createEOperation(placeConfigurationEClass,
				PLACE_CONFIGURATION___REMOVE_TOKEN);

		transitionConfigurationEClass = createEClass(TRANSITION_CONFIGURATION);
		createEOperation(transitionConfigurationEClass,
				TRANSITION_CONFIGURATION___FIRE);
		createEOperation(transitionConfigurationEClass,
				TRANSITION_CONFIGURATION___IS_ENABLED);

		tokenDistributionEClass = createEClass(TOKEN_DISTRIBUTION);
		createEReference(tokenDistributionEClass,
				TOKEN_DISTRIBUTION__INITIAL_TOKENS);
	...
	public void initializePackageContents() {
		...
		Petrinet2Package thePetrinet2Package = (Petrinet2Package) EPackage.Registry.INSTANCE
				.getEPackage(Petrinet2Package.eNS_URI);
		...
		netConfigurationEClass.getESuperTypes().add(
				thePetrinet2Package.getNet());
		placeConfigurationEClass.getESuperTypes().add(
				thePetrinet2Package.getPlace());
		transitionConfigurationEClass.getESuperTypes().add(
				thePetrinet2Package.getTransition());

		// Initialize classes, features, and operations; add parameters
		initEClass(netConfigurationEClass, NetConfiguration.class,
				"NetConfiguration", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEOperation(getNetConfiguration__Run(), null, "run", 0, 1,
				IS_UNIQUE, IS_ORDERED);

		EOperation op = initEOperation(getNetConfiguration__Main__EList(),
				null, "main", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getToken(), "initialTokens", 0, -1, IS_UNIQUE,
				IS_ORDERED);

		op = initEOperation(getNetConfiguration__InitializeMarking__EList(),
				null, "initializeMarking", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getToken(), "initialTokens", 0, -1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(placeConfigurationEClass, PlaceConfiguration.class,
				"PlaceConfiguration", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPlaceConfiguration_HeldTokens(), this.getToken(),
				null, "heldTokens", null, 0, -1, PlaceConfiguration.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEOperation(getPlaceConfiguration__AddToken(), null, "addToken", 0,
				1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getPlaceConfiguration__RemoveToken(), null,
				"removeToken", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(transitionConfigurationEClass,
				TransitionConfiguration.class, "TransitionConfiguration",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEOperation(getTransitionConfiguration__Fire(), null, "fire", 0, 1,
				IS_UNIQUE, IS_ORDERED);

		initEOperation(getTransitionConfiguration__IsEnabled(),
				ecorePackage.getEBoolean(), "isEnabled", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		initEClass(tokenDistributionEClass, TokenDistribution.class,
				"TokenDistribution", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTokenDistribution_InitialTokens(), this.getToken(),
				null, "initialTokens", null, 0, -1, TokenDistribution.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(tokenEClass, Token.class, "Token", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getToken_HoldingPlace(), thePetrinet2Package.getPlace(),
				null, "holdingPlace", null, 1, 1, Token.class, !IS_TRANSIENT,
