 ...
 * @generated
 */
public class XmofxdsmlAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public XmofxdsmlAdapterFactory() {
	 ...
	 * @generated
	 */
	protected XmofxdsmlSwitch<Adapter> modelSwitch =
		new XmofxdsmlSwitch<Adapter>() {
			@Override
			public Adapter caseXMOFLanguageDefiniton(XMOFLanguageDefiniton object) {
				return createXMOFLanguageDefinitonAdapter();
			}
			@Override
			public Adapter caseXMFFile(XMFFile object) {
				return createXMFFileAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link xmofxdsml.XMOFLanguageDefiniton <em>XMOF Language Definiton</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createXMOFLanguageDefinitonAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link xmofxdsml.XMFFile <em>XMF File</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createXMFFileAdapter() {
		return null;
	}
