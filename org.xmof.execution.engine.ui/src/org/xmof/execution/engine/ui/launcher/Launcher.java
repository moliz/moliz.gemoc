...
import org.xmof.execution.engine.XMOFExecutionModelContext;
import org.xmof.execution.engine.ui.Activator;
import org.xmof.execution.engine.ui.commons.RunConfiguration;
import org.xmof.execution.engine.ui.debug.XMOFModelDebugger;
...
public class Launcher extends AbstractGemocLauncher {
	...
	protected IDSLDebugger getDebugger(ILaunchConfiguration configuration, DSLDebugEventDispatcher dispatcher,
		...
		if (traceAddons.isEmpty()) {
			res = new XMOFModelDebugger(dispatcher, (ISequentialExecutionEngine) executionEngine);
		} else {
			
			res = null;
//			res = new OmniscientGenericSequentialModelDebugger(dispatcher,
//					(ISequentialExecutionEngine) executionEngine, traceAddons.iterator().next());
		}
